...
abstract class AbstractMouseWheel {
   ...
   static js5Worker cacheIndex4;
   static int[][][] anIntAarrayArrayArray1903;
   ...
   abstract void removeMouseWheel(Component var2);
   ...
   static final void method2083(int var0, int var1, int var2, byte[][][] var3, int var4, byte var5, int var6, int var7) {
      ...
      int var15;
      int var29;
      for(int var12 = Class3_Sub13_Sub35.anInt3419; var12 < TransformList.anInt2456; ++var12) {
         GroundTile[][] var13 = Class75_Sub2.groundTiles[var12];

         for(var14 = Class163_Sub1_Sub1.anInt4006; var14 < Class2.anInt67; ++var14) {
            for(var15 = AbstractObjectCache.anInt3603; var15 < PlainTile.anInt1665; ++var15) {
               GroundTile var16 = var13[var14][var15];
               if(var16 != null) {
      ...
      boolean var22 = Class44.anIntArrayArrayArray723 == AbstractObjectCache.anIntArrayArrayArray3605;
      if(HDToolkit.openGLEnabled) {
         ...
         if(var22) {
            ...
            for(var14 = 0; var14 < Class3_Sub23.aClass3_Sub11ArrayArray2542[0].length; ++var14) {
               ...
               if(var28.anInt2355 != jSocket.anInt1244) {
                  jSocket.anInt1244 = var28.anInt2355;
                  Class3_Sub28_Sub2.method535((byte)56, var28.anInt2355);
                  AtmosphereManager.method1512(Class72.method1297());
               }

               var28.method149(Class75_Sub2.groundTiles, var26, false);
            }

            Class165.method2253();
         } else {
            for(var14 = Class3_Sub13_Sub35.anInt3419; var14 < TransformList.anInt2456; ++var14) {
               for(var15 = 0; var15 < Class3_Sub23.aClass3_Sub11ArrayArray2542[var14].length; ++var15) {
                  ...
                  if(var25.anInt2351 != -1 && Rasterizer.anInterface2_838.method18(var25.anInt2351, 255) == 4 && Class128.aBoolean1685) {
                     Class3_Sub28_Sub2.method535((byte)56, var25.anInt2355);
                  }

                  var25.method149(Class75_Sub2.groundTiles, var33, false);
               }
            ...
            LightManager.method1277(Class97.anInt1375, Class3_Sub13_Sub27.anInt3340, Class75_Sub2.groundTiles);
         }
      ...
      int var34;
      int var32;
      for(var23 = Class3_Sub13_Sub35.anInt3419; var23 < TransformList.anInt2456; ++var23) {
         var27 = Class75_Sub2.groundTiles[var23];
            ...
            if(var32 >= Class163_Sub1_Sub1.anInt4006 || var29 < Class2.anInt67) {
               for(var34 = -Class3_Sub13_Sub39.anInt3466; var34 <= 0; ++var34) {
                  ...
                  if(var32 >= Class163_Sub1_Sub1.anInt4006) {
                     if(var19 >= AbstractObjectCache.anInt3603) {
   ...
   abstract void addMouseWheel(Component var1);
