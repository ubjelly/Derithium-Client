...
final class AtmosphereManager {
   ...
   static int screenColor = 16777215;
   ...
   static final void method1506(int color, float var1, float var2, float var3) {
      if(anInt1313 != color || aFloat1320 != var1 || aFloat1317 != var2 || aFloat1318 != var3) {
         anInt1313 = color;
         aFloat1320 = var1;
         aFloat1317 = var2;
         aFloat1318 = var3;
   ...
   private static final void method1513() {
      method1506(screenColor, 1.1523438F, 0.69921875F, 1.2F);
      method1509(-50.0F, -60.0F, -50.0F);
      method1508(fogColor, 0);
   }
