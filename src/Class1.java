...
final class Class1 {
   ...
   static jString aClass94_53;
   static boolean[] aBooleanArray54;
   static int anInt55;
   static int anInt56;
   static int anInt57;
   static jString aClass94_58;


   static final void method69(Huffman var0, int var1) {
      try {
         if(var1 < 2) {
            method69((Huffman)null, -115);
         }
      ...
      try {
         ...
         for(var13 = 1; var13 <= 102; ++var13) {
            for(var14 = 1; ~var14 >= -103; ++var14) {
               ...
               if(~var16 != -1) {
                  UnderlayType var17 = UnderlayType.list(-1 + var16);
                  ...
                  if(var17.aBoolean2092 && var15 != 0) {
                     var18.anInt2342 += AbstractObjectCache.anIntArray3607[var19];
                  }
               }
               ...
               if(-1 != ~(var9[var13][var14] & 255) || ~var16 != -1 && ~var8[var13][var14] == -1) {
                  ...
                  if(0 != var27 && ~var16 != ~var27) {
                     var31 = UnderlayType.list(-1 + var27);
                  ...
                  if(-1 != ~var28 && var28 != var16) {
                     var31 = UnderlayType.list(-1 + var28);
                  ...
                  if(-1 != ~var29 && ~var16 != ~var29) {
                     var31 = UnderlayType.list(var29 - 1);
                     if(var31.aBoolean2092 && ~var31.anInt2103 != 0) {
                        var32 = var5[1 + var13][var14 - 1];
                  ...
                  if(var30 != 0 && ~var30 != ~var16) {
                     var31 = UnderlayType.list(var30 + -1);
                     if(var31.aBoolean2092 && 0 != ~var31.anInt2103) {
                  ...
                  if(-1 != ~var23 && ~var16 != ~var23) {
                     var31 = UnderlayType.list(-1 + var23);
                  ...
                  if(0 != var24 && ~var16 != ~var24) {
                     var31 = UnderlayType.list(var24 + -1);
                     if(var31.aBoolean2092 && var31.anInt2103 != -1) {
                  ...
                  if(-1 != ~var25 && var16 != var25) {
                     var31 = UnderlayType.list(-1 + var25);
                     if(var31.aBoolean2092 && ~var31.anInt2103 != 0) {
                  ...
                  if(0 != var26 && var16 != var26) {
                     var31 = UnderlayType.list(var26 - 1);
                     if(var31.aBoolean2092 && ~var31.anInt2103 != 0) {
                  ...
                  for(var73 = 0; var58 > var73; ++var73) {
                     ...
                     UnderlayType var37 = UnderlayType.list(-1 + var74);
         ...
         Class3_Sub11 var56;
         for(var56 = (Class3_Sub11)var12.getFirst(); null != var56; var56 = (Class3_Sub11)var12.getNext()) {
            var56.method145();
         }
         ...
         for(var13 = 1; 102 >= var13; ++var13) {
            for(var14 = 1; ~var14 >= -103; ++var14) {
               ...
               if(0 != var58) {
                  UnderlayType var62 = UnderlayType.list(-1 + var58);
                  ...
                  var22 = Class3_Sub13_Sub4.method190(var62.anInt2095, var62.anInt2103, var6[var13][var14]);
                  var23 = Class3_Sub13_Sub4.method190(var62.anInt2095, var62.anInt2103, var6[var13 + 1][var14]);
                  var24 = Class3_Sub13_Sub4.method190(var62.anInt2095, var62.anInt2103, var6[1 + var13][var14 + 1]);
                  var25 = Class3_Sub13_Sub4.method190(var62.anInt2095, var62.anInt2103, var6[var13][var14 - -1]);
                  Varp.method971(var22, var2, var1, var13, var0, var23, var68, var15, var24, (byte)88, ~var16 != -1 && var62.aBoolean2092, var67, var14, var4, var25, var66);
               }
               ...
               if(~(var9[var13][var14] & 255) != -1 || ~var58 != -1 && 0 == var8[var13][var14]) {
                  ...
                  if(0 != var28 && var28 != var58) {
                     var76 = UnderlayType.list(-1 + var28);
                  ...
                  if(0 != var29 && ~var58 != ~var29) {
                     var76 = UnderlayType.list(-1 + var29);
                  ...
                  if(var30 != 0 && ~var30 != ~var58) {
                     var76 = UnderlayType.list(-1 + var30);
                     if(var76.aBoolean2092 && -1 != var76.anInt2103) {
                  ...
                  if(~var73 != -1 && ~var58 != ~var73) {
                     var76 = UnderlayType.list(-1 + var73);
                     if(var76.aBoolean2092 && var76.anInt2103 != -1) {
                        var77 = var8[1 + var13][1 + var14];
                        var33 = var5[1 + var13][var14 + 1];
                  ...
                  if(-1 != ~var24 && ~var24 != ~var58) {
                     var76 = UnderlayType.list(var24 - 1);
                     if(var76.aBoolean2092 && -1 != var76.anInt2103) {
                  ...
                  if(var25 != 0 && var58 != var25) {
                     var76 = UnderlayType.list(var25 + -1);
                  ...
                  if(var26 != 0 && ~var26 != ~var58) {
                     var76 = UnderlayType.list(var26 - 1);
                     if(var76.aBoolean2092 && -1 != var76.anInt2103) {
                  ...
                  if(var27 != 0 && var27 != var58) {
                     var76 = UnderlayType.list(var27 + -1);
                     if(var76.aBoolean2092 && var76.anInt2103 != -1) {
                  ...
                  for(var74 = 0; ~var74 > ~var61; ++var74) {
                     ...
                     UnderlayType var82 = UnderlayType.list(-1 + var78);
                     Class3_Sub11 var39 = AnimationDefinition.method2052(var12, var82);
                     int var40 = Class3_Sub13_Sub4.method190(var82.anInt2095, var82.anInt2103, var6[var13][var14]) << 8 | 255;
                     byte var44 = 6;
                     int var41 = 255 | Class3_Sub13_Sub4.method190(var82.anInt2095, var82.anInt2103, var6[1 + var13][var14]) << 8;
                     int var42 = Class3_Sub13_Sub4.method190(var82.anInt2095, var82.anInt2103, var6[var13 - -1][var14 - -1]) << 8 | 255;
                     int var43 = 255 | Class3_Sub13_Sub4.method190(var82.anInt2095, var82.anInt2103, var6[var13][var14 - -1]) << 8;
   ...
   /*static final void method72(int var0, int var1, int var2, int var3, int var4) {
      try {
         if(HDToolkit.openGLEnabled) {
            GraphicsHD.clipRect(var0, var4, var2 + var0, var1 + var4);
            GraphicsHD.fillRect(var0, var4, var2, var1, 0);
         } else {
            GraphicsLD.clipRect(var0, var4, var2 + var0, var4 + var1);
            GraphicsLD.fillRect(var0, var4, var2, var1, 0);
         }

         if(~Class140_Sub3.anInt2737 <= -101) {
            if(null == Huffman.aClass3_Sub28_Sub16_637 || var2 != Huffman.aClass3_Sub28_Sub16_637.width || Huffman.aClass3_Sub28_Sub16_637.height != var1) {
               LDSprite var5 = new LDSprite(var2, var1);
               GraphicsLD.init2dCanvas(var5.pixels, var2, var1);
               NodeSub.method523(var2, 0, 0, Class23.anInt455, 0, 0, Class108.anInt1460, var1, 0);
               if(HDToolkit.openGLEnabled) {
                  Huffman.aClass3_Sub28_Sub16_637 = new HDSprite(var5);
               } else {
                  Huffman.aClass3_Sub28_Sub16_637 = var5;
               }
            ...
            Huffman.aClass3_Sub28_Sub16_637.drawFlippedSprite(var0, var4);
            if(var3 != 19481) {
            ...
            if(HDToolkit.openGLEnabled) {
               GraphicsHD.fillRectAlpha(var15, var6, var7, var8, var9, 128);
               GraphicsHD.drawRect(var15, var6, var7, var8, var9);
            } else {
               GraphicsLD.fillRectAlpha(var15, var6, var7, var8, var9, 128);
               GraphicsLD.drawRect(var15, var6, var7, var8, var9);
            }

            if(~AbstractSprite.anInt3704 < -1) {
               int var10;
               ...
               for(Class3_Sub23 var11 = (Class3_Sub23)Class84.aClass61_1162.getFirst(); var11 != null; var11 = (Class3_Sub23)Class84.aClass61_1162.getNext()) {
                  if(~var11.anInt2532 == ~Class8.anInt101) {
                     ...
                     if(HDToolkit.openGLEnabled) {
                        GraphicsHD.fillRectAlpha(-2 + var12, -2 + var13, 4, 4, 16776960, var10);
                     } else {
                        GraphicsLD.fillRectAlpha(var12 + -2, -2 + var13, 4, 4, 16776960, var10);
                     }
                  }
               }
            }
   ...
   static {
      ...
      aClass94_53 = jString.createJString("scape main");
      anInt57 = 0;
      aClass94_58 = jString.createJString("<col=ffffff> )4 ");
   }
}
