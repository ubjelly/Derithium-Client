...
final class Class103 {
   ...
   final void method1620(Buffer var1, Class34 var2) {
      int var3 = var1.getUByte();
      this.anIntArray1434[0] = var3 >> 4;
      this.anIntArray1434[1] = var3 & 15;
      if(var3 != 0) {
         this.anIntArray1437[0] = var1.getUShort();
         this.anIntArray1437[1] = var1.getUShort();
         ...
         for(var5 = 0; var5 < 2; ++var5) {
            for(var6 = 0; var6 < this.anIntArray1434[var5]; ++var6) {
               this.anIntArrayArrayArray1430[var5][0][var6] = var1.getUShort();
               this.anIntArrayArrayArray1432[var5][0][var6] = var1.getUShort();
            }
         }
         ...
         for(var5 = 0; var5 < 2; ++var5) {
            for(var6 = 0; var6 < this.anIntArray1434[var5]; ++var6) {
               if((var4 & 1 << var5 * 4 << var6) != 0) {
                  this.anIntArrayArrayArray1430[var5][1][var6] = var1.getUShort();
                  this.anIntArrayArrayArray1432[var5][1][var6] = var1.getUShort();
               } else {
