...
final class Class112 implements Interface5 {
   ...
   public final void method23(int var1) {
      ...
      if((var1 & 1) == 1) {
         if(Class88.aBoolean1227) {
            ...
            HDToolkit.bindTexture(Class88.anIntArray1224[HDToolkit.anInt1791 * 64 / 100 % 64]);
         }
         ...
         HDToolkit.bindTexture(Class88.anIntArray1224[0]);
      }
   ...
   public final void method22() {
      ...
      var2 += (float)(ItemPile.renderPitch2 - 128) * 0.5F;
      if(var2 >= 3328.0F) {
         var2 = 3327.0F;
      }
