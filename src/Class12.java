...
final class Class12 {
   ...
   SceneGraphNode aClass140_320;
   private static jString aClass94_321 = jString.createJString("Checking for updates )2 ");
   static js5 aClass153_322;
   static js5 aClass153_323;
   int anInt324;
   int anInt326;
   static jString aClass94_327 = aClass94_321;
   long aLong328;
   boolean aBoolean329 = false;
   int anInt330;
   static jString aClass94_331 = jString.createJString("(U1");
