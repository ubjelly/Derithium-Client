...
final class Class125 implements Interface5 {
   ...
   static boolean blackIssueFix = true;
   ...
   public final void method22() {
      if(this.anInt2186 >= 0) {
         ...
         var1.glTranslatef((float)Class9.renderX2, (float)ClientScript.renderZ2, (float)StringNode.renderY2);
         var1.glRotatef(-((float)Class3_Sub13_Sub8.renderYaw2 * 360.0F) / 2048.0F, 0.0F, 1.0F, 0.0F);
         var1.glRotatef(-((float)ItemPile.renderPitch2 * 360.0F) / 2048.0F, 1.0F, 0.0F, 0.0F);
   ...
   public Class125() {
      if(this.anInt2186 < 0) {
         if(HDToolkit.aBoolean1818 && HDToolkit.maxTextureUnits >= 2) {
            int[] var1 = new int[1];
            GL var2 = HDToolkit.gl;
            ...
            for(int var6 = 0; var6 < 256; ++var6) {
               ...
               for(int var9 = 0; var9 < 64; ++var9) {
                  if(HDToolkit.isBigEndianOrder) {
                     ...
                     var5.method762((float)var7[var9] / 4096.0F);
                     var5.method762((float)var8[var9] / 4096.0F);
                     var5.method762(1.0F);
                     var5.method762(1.0F);
                  }
               }
            ...
            ByteBuffer var10 = ByteBuffer.allocateDirect(var5.pos).order(ByteOrder.nativeOrder());
            var10.put(var5.buf, 0, var5.pos);
            var10.flip();
