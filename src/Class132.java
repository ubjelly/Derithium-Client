...
final class Class132 {
   ...
   static js5 aClass153_1735;
   static int anInt1736;
   static int anInt1737 = 1;
   static jString aClass94_1738 = jString.createJString("<col=ffff00>");
   static jString[] aClass94Array1739 = new jString[1000];
   ...
   static final void method1798(int var0, Class3_Sub4 var1) {
      try {
         ...
         if(var1.anInt2263 == 2) {
            var2 = AnimationLoader.method557(var1.anInt2250, var1.anInt2264, var1.anInt2248);
         }

         if(~var1.anInt2263 == -4) {
            var2 = GroundTile.method104(var1.anInt2250, var1.anInt2264, var1.anInt2248);
         }
   ...
   static final void method1799(byte var0, js5 var1) {
      try {
   ...
   public static void method1800(byte var0) {
      try {
         ...
         aClass153_1735 = null;
         if(var0 <= 52) {
            aClass94Array1739 = (jString[])null;
         }
   ...
   static final void method1801(byte var0) {
      try {
         if(var0 >= -94) {
            method1799((byte)-90, (js5)null);
         }

         int var1 = client.getBoldFont().method682(Class75_Sub4.aClass94_2667);

         int var2;
         int var3;
         for(var2 = 0; Class3_Sub13_Sub34.anInt3415 > var2; ++var2) {
            var3 = client.getBoldFont().method682(Buffer.method802(var2, true));
            if(var3 > var1) {
               var1 = var3;
            }
         }
         ...
         if(~(var4 + var2) < ~ItemPile.canvasHei) {
            var4 = ItemPile.canvasHei + -var2;
         }
         ...
         if(-2 == ~EnumType.anInt3660) {
            if(~NpcDefinition.anInt1297 == ~Class3_Sub13_Sub39.anInt3460 && ~UnderlayType.anInt2099 == ~Class38_Sub1.anInt2612) {
               Class3_Sub28_Sub1.anInt3537 = Class3_Sub13_Sub34.anInt3415 * 15 - -(!js5.aBoolean1951?22:26);
            ...
            Class3_Sub28_Sub3.anInt3552 = var1;
            Class3_Sub13_Sub33.anInt3395 = var4;
            Class3_Sub28_Sub1.anInt3537 = (js5.aBoolean1951?26:22) + Class3_Sub13_Sub34.anInt3415 * 15;
            Class38_Sub1.aBoolean2615 = true;
         } else {
            UnderlayType.anInt2099 = Class38_Sub1.anInt2614;
            Class3_Sub13_Sub39.anInt3460 = Class163_Sub1.anInt2993;
            EnumType.anInt3660 = 1;
         }
