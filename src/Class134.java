...
final class Class134 {
   ...
   static jString aClass94_1760 = jString.createJString("");
   ...
   static jString aClass94_1764 = jString.createJString("headicons_prayer");
   ...
   static final synchronized byte[] method1807(int var0, int var1) {
      try {
         ...
         if(~var1 == -101 && -1 > ~Class65.anInt984) {
            ...
            if(~var1 == -5001 && MouseHandler.anInt1927 > 0) {
               var2 = Class9.aByteArrayArray125[--MouseHandler.anInt1927];
               Class9.aByteArrayArray125[MouseHandler.anInt1927] = null;
               return var2;
   ...
   static final void method1808(int var0, boolean var1, byte var2, int var3, boolean var4) {
      try {
         FileSystem.method1047(var0, var3, Class3_Sub13_Sub16.aClass44_Sub1Array3201.length - 1, var4, 0, var1, false);
         if(var2 != 30) {
            aClass94_1760 = (jString)null;
         }
