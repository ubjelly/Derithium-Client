...
final class Class135 {
   ...
   static final Class135 method1811(js5 var0, int var1, int var2) {
      byte[] var3 = var0.getFile(var1, var2);
      return var3 == null?null:new Class135(new Buffer(var3));
   }
   ...
   private Class135(Buffer var1) {
      ...
      this.anInt1769 = var1.getUShort();
      this.anInt1767 = var1.getUShort();
   }
