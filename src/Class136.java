...
final class Class136 {
   ...
   private static jString aClass94_1775 = jString.createJString("Connection lost)3");
   SceneGraphNode aClass140_1777;
   static SignlinkNode aClass64_1778;
   static short[] aShortArray1779 = new short[256];
   static jString aClass94_1773 = aClass94_1775;
   ...
   /*static final void method1814(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      try {
                  ...
                  for(int var23 = -var16; var23 < var12 - -var16; ++var23) {
                     ...
                     if(0 < var26) {
                        ...
                        if(~var27 <= -1 && ~var27 >= ~(-1 + var22.length) && null != var22[var27]) {
                           ...
                           if(-1 != ~var29) {
                              ObjectDefinition var14 = ObjectDefinition.list(-1 + var29);
                              if(!Class3_Sub24_Sub4.aBooleanArray3503[var14.anInt1482]) {
                                 if(~var13 != 0 && ~var14.anInt1482 == ~Class8.anInt101) {
                                    ...
                                    Class101.aClass61_1424.insertBack(var30);
                                 } else {
                                    SceneGraphNode.aClass3_Sub28_Sub16_Sub2Array1839[var14.anInt1482].method643(var18 + -7, -7 + var24);
                                 }
                              }
                           }
                        }
         ...
         if(var7 >= 124) {
            for(Class3_Sub23 var32 = (Class3_Sub23)Class101.aClass61_1424.getFirst(); null != var32; var32 = (Class3_Sub23)Class101.aClass61_1424.getNext()) {
               GraphicsLD.method1330(var32.anInt2531, var32.anInt2539, 15, 16776960, var13);
               GraphicsLD.method1330(var32.anInt2531, var32.anInt2539, 13, 16776960, var13);
               GraphicsLD.method1330(var32.anInt2531, var32.anInt2539, 11, 16776960, var13);
               GraphicsLD.method1330(var32.anInt2531, var32.anInt2539, 9, 16776960, var13);
               SceneGraphNode.aClass3_Sub28_Sub16_Sub2Array1839[var32.anInt2532].method643(-7 + var32.anInt2531, -7 + var32.anInt2539);
            }

            Class101.aClass61_1424.clear();
         }
