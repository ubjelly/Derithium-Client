...
final class Class141 {
   ...
   private static final void method2034(LDIndexedSprite var0, LDIndexedSprite var1, int var2, int var3) {
      ...
      if(var7 > 0 && var6 > 0) {
         method2044(var1.indicators, var0.indicators, var5, var4, var7, var6, var8, var9);
      ...
      if(!var2 || !var3) {
         if(!var2 || var0 != 1) {
            if(!var3 || var0 != 0) {
               ...
               int var12 = var5 << 7;
               int var13 = var10 - (var11 * AtmosphereManager.anInt1314 >> 8) >> 3;
               int var14 = var12 - (var11 * AtmosphereManager.anInt1315 >> 8) >> 3;
   ...
   private static final boolean method2040(LDIndexedSprite var0, LDIndexedSprite var1, int var2, int var3) {
      ...
      if(var6 > 0 && var5 > 0) {
         ...
         return method2039(var1.indicators, var4, var6, var5, var7, var9);
      } else {
         return false;
      }
   }
   ...
   private static final void method2042(LDIndexedSprite var0, LDIndexedSprite var1, int var2, int var3) {
      ...
      if(var7 > 0 && var6 > 0) {
         method2035(var1.indicators, var0.indicators, var5, var4, var7, var6, var8, var9);
         method2036(var2, var3, var7, var6);
      }
   }
   ...
   static final void method2047(LDIndexedSprite var0, int var1, int var2, int var3) {
      if(var0 != null) {
         int var4 = var1 - (var2 * AtmosphereManager.anInt1314 >> 8) >> 3;
         int var5 = var3 - (var2 * AtmosphereManager.anInt1315 >> 8) >> 3;
   ...
   private static final void method2050(LDIndexedSprite var0, LDIndexedSprite var1, int var2, int var3, int var4, boolean var5) {
      if(var2 > 0 && var3 > 0 && var2 + 16 < var1.width && var3 + 16 < var1.height) {
         ...
         if(var5) {
            method2046(var1.indicators, var0.indicators, var8, var6, var7, var9, var10);
         } else {
            method2048(var1.indicators, var0.indicators, var8, var6, var7, var9, var10);
         }
