...
final class Class143 {
   ...
   private static jString aClass94_1876 = jString.createJString("Loaded fonts");
   //static jString aClass94_1877 = jString.createJString(":assist:");
   static jString aClass94_1879 = aClass94_1876;
   static jString aClass94_1880 = jString.createJString(")1");
   ...
   static final void method2062(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      try {
         ...
         for(var16 = var12; ~var16 > ~var8; ++var16) {
            Class3_Sub13_Sub23_Sub1.method282(Class38.anIntArrayArray663[var16], var14, var15, var5);
         }
         ...
         if(var2 >= -88) {
            aClass94_1876 = (jString)null;
         }

         for(var16 = var8; ~var16 >= ~var9; ++var16) {
            int[] var17 = Class38.anIntArrayArray663[var16];
            Class3_Sub13_Sub23_Sub1.method282(var17, var14, var10, var5);
            Class3_Sub13_Sub23_Sub1.method282(var17, var10, var11, var1);
            Class3_Sub13_Sub23_Sub1.method282(var17, var11, var15, var5);
         }
