...
abstract class Class151 {
   ...
   //static jString aClass94_1932 = jString.createJString(")4a=");
   static jInterface aClass11_1933;
   static float[] aFloatArray1934 = new float[]{0.073F, 0.169F, 0.24F, 1.0F};
   static jString aClass94_1935 = jString.createJString("::clientdrop");
   ...
   static final boolean method2096(int var0, int var1, int var2, long var3) {
      GroundTile var5 = Class75_Sub2.groundTiles[var0][var1][var2];
      if(var5 == null) {
         return false;
   ...
   static final void method2099(boolean var0, int var1, int var2, js5 var3, boolean var4, int var5, int var6) {
      try {
