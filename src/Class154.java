...
final class Class154 {
   ...
   private static jString aClass94_1958 = jString.createJString("Please wait )2 attempting to reestablish)3");
   static jString aClass94_1959 = aClass94_1958;
   static int[] anIntArray1960 = new int[14];
   
   private static jString aClass94_1963 = jString.createJString("glow2:");
   static Class93 aClass93_1964 = new Class93(5);
   static Class93 aClass93_1965 = new Class93(50);
   static int anInt1966 = -1;
   static js5 aClass153_1967;
static jString aClass94_1961 = aClass94_1963;
   static jString aClass94_1962 = aClass94_1963;
   ...
   static final void method2146(int var0, int var1, int var2, int var3, SceneGraphNode var4, SceneGraphNode var5, int var6, int var7, long var8) {
      if(var4 != null || var5 != null) {
         ...
         for(int var11 = var0; var11 >= 0; --var11) {
            if(Class75_Sub2.groundTiles[var11][var1][var2] == null) {
               Class75_Sub2.groundTiles[var11][var1][var2] = new GroundTile(var11, var1, var2);
            }
         }

         Class75_Sub2.groundTiles[var0][var1][var2].aClass70_2234 = var10;
      }
   }
   ...
   static final jString method2148(int var0, byte var1) {
      try {
         if(999999999 <= var0) {
            if(var1 != -78) {
               method2145((byte)-8);
