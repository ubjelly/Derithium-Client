...
class Class155 {
   ...
   static jString aClass94_1970 = jString.createJString(":");
   static int anInt1971;
   private long aLong1972 = TimeUtil.currentTimeMillis();
   ...
   private final void method2152(int[] var1, int var2) {
      int var3 = var2;
      if(jString.aBoolean2150) {
         var3 = var2 << 1;
      }

      ArrayUtils.clear(var1, 0, var3);
      this.anInt1987 -= var2;
      ...
      this.aLong1972 = TimeUtil.currentTimeMillis();
   }
   ...
   static final Class10 method2156(int var0, Buffer var1) {
      try {
         Class10 var2 = new Class10();
         var2.anInt149 = var1.getUShort();
         if(var0 != 1024) {
            method2162((SceneGraphNode)null, 34, 103, -93);
         }

         var2.aClass3_Sub28_Sub4_151 = StringNode.method733(var2.anInt149);
         return var2;
   ...
   final synchronized void method2158() {
         ...
         try {
            ...
            this.method2160();
            this.aLong1982 = TimeUtil.currentTimeMillis() + 2000L;
         }
   }
   ...
   static final void method2162(SceneGraphNode var0, int var1, int var2, int var3) {
      GroundTile var4;
      if(var2 < jSocket.anInt1234) {
         var4 = Class75_Sub2.groundTiles[var1][var2 + 1][var3];
      ...
      if(var3 < jSocket.anInt1234) {
         var4 = Class75_Sub2.groundTiles[var1][var2][var3 + 1];
         if(var4 != null && var4.aClass12_2230 != null && var4.aClass12_2230.aClass140_320.method1865()) {
            var0.method1866(var4.aClass12_2230.aClass140_320, 0, 0, 128, true);
         }
      }

      if(var2 < jSocket.anInt1234 && var3 < Class3_Sub13_Sub15.anInt3179) {
         var4 = Class75_Sub2.groundTiles[var1][var2 + 1][var3 + 1];
         if(var4 != null && var4.aClass12_2230 != null && var4.aClass12_2230.aClass140_320.method1865()) {
            var0.method1866(var4.aClass12_2230.aClass140_320, 128, 0, 128, true);
         }
      }

      if(var2 < jSocket.anInt1234 && var3 > 0) {
         var4 = Class75_Sub2.groundTiles[var1][var2 + 1][var3 - 1];
         if(var4 != null && var4.aClass12_2230 != null && var4.aClass12_2230.aClass140_320.method1865()) {
            var0.method1866(var4.aClass12_2230.aClass140_320, 128, 0, -128, true);
         }
