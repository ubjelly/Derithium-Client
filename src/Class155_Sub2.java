...
final class Class155_Sub2 extends Class155 {
   ...
   final void method2164(Component var1) {
      ...
      this.anAudioFormat2974 = new AudioFormat((float)Class21.anInt443, 16, !jString.aBoolean2150?1:2, true, false);
      this.aByteArray2975 = new byte[256 << (jString.aBoolean2150?2:1)];
   }

   final void method2150(int var1) throws LineUnavailableException {
      try {
         javax.sound.sampled.DataLine.Info var2 = new javax.sound.sampled.DataLine.Info(SourceDataLine.class, this.anAudioFormat2974, var1 << (!jString.aBoolean2150?1:2));
         ...
         if(~AbstractMouseWheel.method2080(var1, -125) == -2) {
            this.aSourceDataLine2972 = null;
            throw var3;
         } else {
            this.method2150(Class95.method1585(var1));
         }
      }
   }
   ...
   final void method2151() throws LineUnavailableException {
      ...
      if(this.aBoolean2973) {
         this.aSourceDataLine2972.close();
         this.aSourceDataLine2972 = null;
         javax.sound.sampled.DataLine.Info var1 = new javax.sound.sampled.DataLine.Info(SourceDataLine.class, this.anAudioFormat2974, this.anInt2971 << (!jString.aBoolean2150?1:2));
   ...
   final int method2157() {
      return this.anInt2971 - (this.aSourceDataLine2972.available() >> (!jString.aBoolean2150?1:2));
   }
