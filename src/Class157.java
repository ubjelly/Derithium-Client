...
final class Class157 {
   ...
   static LDFont aClass3_Sub28_Sub17_Sub1_2000;
   private int anInt2001;
   //static jString aClass94_2003 = jString.createJString("_labels");
   static jString aClass94_1995 = jString.createJString("Connecting to update server");
   ...
   static final LDSprite[] method2176(js5 var3, int var0, int var2) {
	   if(client.spriteExists(var3, var0, var2)) {
