...
final class Class159 {
   ...
   static jString aClass94_2018 = jString.createJString("Cabbage");
   static js5Worker cacheIndex7;
   ...
   static final Class12 method2193(int var0, int var1, int var2) {
	...
	/*static final boolean method2194() {
		if (Class3_Sub28_Sub11.aBoolean3641) {
			try {
				return !((Boolean) Class3_Sub13_Sub17.aClass94_3209.method1577(Class38.gameSignlink.thisApplet)).booleanValue();
   ...
   static final void method2195(int var0, int var1) {
      try {
         ...
         for(var6 = 0; var2 + -var0 > var6; ++var6) {
            AnimationLoader.anIntArray3592[var6] = AnimationLoader.anIntArray3592[var6 - -var0];
         }

         for(var6 = var2 - var0; var2 > var6; ++var6) {
            AnimationLoader.anIntArray3592[var6] = (int)(Math.sin((double)Class1.anInt57 / 14.0D) * 16.0D + 14.0D * Math.sin((double)Class1.anInt57 / 15.0D) + 12.0D * Math.sin((double)Class1.anInt57 / 16.0D));
            ++Class1.anInt57;
         }

         Class132.anInt1740 += var0;
         var6 = (var0 - -(1 & Class44.loopCycle)) / 2;
         if(~var6 < -1) {
            ...
            for(var7 = 0; ~var2 < ~var7; ++var7) {
               ...
               for(var10 = -var6; ~var10 > -129; ++var10) {
                  ...
                  if(0 <= var10) {
                     PacketBuffer.anIntArray3805[var10 + var9] = var8 / (1 + var6 * 2);
                  }
               }
            }
            ...
            for(var7 = 0; 128 > var7; ++var7) {
               ...
               for(var9 = -var6; var2 > var9; ++var9) {
                  var10 = var9 * 128;
                  if(~(var9 + var6) > ~var2) {
                     var8 += PacketBuffer.anIntArray3805[var6 * 128 + (var7 - -var10)];
                  }

                  if(0 <= var9 - var6 - 1) {
                     var8 -= PacketBuffer.anIntArray3805[-((1 + var6) * 128) + (var7 - -var10)];
                  }
   ...
   static final void method2196(int var0) {
      try {
         Class3_Sub13_Sub34.aClass93_3412.clearSoftReference();
         if(var0 != 128) {
            anInt2024 = 111;
         }

         Class3_Sub13_Sub31.aClass93_3369.clearSoftReference();
