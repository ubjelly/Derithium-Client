...
final class Class163_Sub2_Sub1 extends Class163_Sub2 {
   ...
   private static jString aClass94_4022 = jString.createJString("Your friend list is full)3 Max of 100 for free users)1 and 200 for members)3");
   static jString aClass94_4023 = jString.createJString(")3");
   static jString aClass94_4024 = aClass94_4022;
   ...
   static final void method2221(int var0, int var1, int var2, int var4, int var5, int var6) {
         ...
         for(HintIcon[] var7 = RuntimeException_Sub1.aClass96Array2114; ~var7.length < ~var8; ++var8) {
            HintIcon var9 = var7[var8];
            if(null != var9 && var9.anInt1360 == 2) {
               Class118.method1724(var0 >> 1, var5, (-Class82.anInt1152 + var9.anInt1347 << 7) - -var9.anInt1350, var9.anInt1353 * 2, var2 >> 1, var9.anInt1346 + (var9.anInt1356 + -Class131.anInt1716 << 7), var4);
               if(-1 < Class32.anInt590 && ~(Class44.loopCycle % 20) > -11) {
                  Class166.aClass3_Sub28_Sub16Array2072[var9.anInt1351].method643(-12 + var1 + Class32.anInt590, -28 + var6 - -ClickMaskNode.anInt2208);
               }
            }
         }
   }
   ...
   static final void method2222(byte var0) {
      try {
         RawObjectCache.aClass93_4043.clearSoftReference();
         InterfaceListener.aClass93_2442.clearSoftReference();
         Class154.aClass93_1964.clearSoftReference();
         if(var0 <= 122) {
                     ...
                     if(!var0 || var9 == 0) {
                        ...
                        for(int var14 = 0; Class3_Sub24_Sub3.anIntArray3494.length > var14; ++var14) {
                           if(~Class3_Sub24_Sub3.anIntArray3494[var14] == ~var13 && var4[var14] != null) {
                              Class3_Sub13_Sub30.method316(Class86.collisionMap, var5, var4[var14], var9, var10, 8 * var6, var7 * 8, var0, (var11 & 7) * 8, 8 * (7 & var12), (byte)-54);
                              break;
                           }
                        }
                     }
   ...
   static final boolean method2224(byte var0, long var1, int var3, int var4) {
      try {
         ...
         if(var5 != 10 && -12 != ~var5 && var5 != 22) {
            Class3_Sub28_Sub9.method582(TextureLoader.selfPlayer.anIntArray2755[0], var6, 0, true, 0, 2, var4, 0, 1 + var5, 2, var3, TextureLoader.selfPlayer.anIntArray2767[0]);
         } else {
            ObjectDefinition var8 = ObjectDefinition.list(var7);
            int var9;
            int var10;
            if(~var6 != -1 && ~var6 != -3) {
               var10 = var8.sizeX;
            ...
            Class3_Sub28_Sub9.method582(TextureLoader.selfPlayer.anIntArray2755[0], 0, var10, true, var11, 2, var4, var9, 0, 2, var3, TextureLoader.selfPlayer.anIntArray2767[0]);
         }
   ...
   static final void method2226(PacketBuffer var0, int var1, int var2) {
      try {
         if(var2 > -109) {
            method2226((PacketBuffer)null, 67, 54);
         }

         while(true) {
            Class3_Sub8 var3 = (Class3_Sub8)Class3_Sub26.aClass61_2557.getFirst();
            if(var3 == null) {
               return;
            }
            ...
            for(int var6 = 0; ~var3.anInt2296 < ~var6; ++var6) {
               if(~var3.anIntArray2300[var6] != -1) {
                  ...
                  try {
                     ...
                     if(-1 != ~var7) {
                        if(~var7 == -2) {
                           var8 = (Field)var3.aClass64Array2303[var6].value;
                     ...
                     Method var26;
                     if(3 == var7) {
                        var26 = (Method)var3.aClass64Array2298[var6].value;
                        ...
                        if(var28 == null) {
                           ...
                           if(var28 instanceof jString) {
                              var0.putByte(2);
                              var0.putString((jString)var28);
                           } else {
                              var0.putByte(4);
                           }
                        } else {
                           var0.putByte(1);
                           var0.putLong(((Number)var28).longValue());
                        }
                     } else if(var7 == 4) {
                        var26 = (Method)var3.aClass64Array2298[var6].value;
            ...
            var0.putSizedByte(var0.pos - var5);
            var3.unlink();
         }
