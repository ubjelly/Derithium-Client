...
final class Class25 {
   ...
   int anInt487;
   static boolean lowMemoryTextures = true;
   int anInt489;
   int anInt490;
   static int anInt491 = 0;
   private static jString aClass94_492 = jString.createJString("RuneScape is loading )2 please wait)3)3)3");
   int anInt493;
   int anInt495;
   int anInt496;
   static int anInt497;
...
static jString aClass94_485 = aClass94_492;

   static final void method953(int var0, int var1) {
      try {
         Class114.aClass93_1569.method1522(var1);
         if(var0 != -13508) {
            aClass94_485 = (jString)null;
         }

         Class3_Sub15.aClass93_2428.method1522(var1);
         Class47.aClass93_743.method1522(var1);
   ...
   static final void method958(byte var0) {
      try {
         if(SceneGraphNode.aBoolean1837) {
            ...
            jInterface var1 = AbstractSprite.method638(SubScript.anInt872, jInterface.anInt278);
            if(null != var1 && var1.anObjectArray303 != null) {
               InterfaceListener var3 = new InterfaceListener();
               var3.objectData = var1.anObjectArray303;
               var3.aClass11_2449 = var1;
               Light.method1065(var3);
            }

            SceneGraphNode.aBoolean1837 = false;
            AnimationLoader.anInt3590 = -1;
            Class20.refreshInterface(var1);
         }
   ...
   static final void method959(int var0) {
      try {
         InterfaceListener.aClass93_2450.clearAll();
         if(var0 != 0) {
            method957(121, true);
         }
