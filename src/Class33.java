...
final class Class33 {
   ...
   private final void method997(jString var1, int var2, int var3, int var4, boolean var5) {
   ...
   private final void method1001(int var1, int var2, int var3, int var4, byte[] var5) {
      ...
      int var11 = var6 + var7 * GraphicsLD.width;
      int var12 = GraphicsLD.width - var8;
      int var13 = 0;
      int var14;
      if(var7 < GraphicsLD.startY) {
         var14 = GraphicsLD.startY - var7;
         var9 -= var14;
         var7 = GraphicsLD.startY;
         var10 += var14 * var8;
         var11 += var14 * GraphicsLD.width;
      }

      if(var7 + var9 >= GraphicsLD.endY) {
         var9 -= var7 + var9 - GraphicsLD.endY + 1;
      }

      if(var6 < GraphicsLD.startX) {
         var14 = GraphicsLD.startX - var6;
         var8 -= var14;
         var6 = GraphicsLD.startX;
         var10 += var14;
         var11 += var14;
         var13 += var14;
         var12 += var14;
      ...
      if(var6 + var8 >= GraphicsLD.endX) {
         var14 = var6 + var8 - GraphicsLD.endX + 1;
         var8 -= var14;
         var13 += var14;
         var12 += var14;
      }
      ...
      if(var8 > 0 && var9 > 0) {
         if(this.aBoolean595) {
            this.method1000(GraphicsLD.pixels, var5, var4, var10, var11, var8, var9, var12, var13);
         } else {
            this.method1002(GraphicsLD.pixels, var5, var4, var10, var11, var8, var9, var12, var13);
         }
      }
   ...
   final void method1003(jString var1, int var2, int var3, int var4, boolean var5) {
      int var6 = this.method1005(var1) / 2;
      int var7 = this.method1006();
      if(var2 - var6 <= GraphicsLD.endX) {
         if(var2 + var6 >= GraphicsLD.startX) {
            if(var3 - var7 <= GraphicsLD.endY) {
               if(var3 >= 0) {
   ...
   private final void method1004(Font var1, FontMetrics var2, char var3, int var4, boolean var5) {
      ...
      Image var11 = InvType.canvas.createImage(var6, var9);
   ...
   private final int method1005(jString var1) {
      int var2 = 0;

      for(int var3 = 0; var3 < var1.getLength(); ++var3) {
         if(var1.method1569(var3, (byte)-41) == 64 && var3 + 4 < var1.getLength() && var1.method1569(var3 + 4, (byte)66) == 64) {
            var3 += 4;
         } else if(var1.method1569(var3, (byte)101) == 126 && var3 + 4 < var1.getLength() && var1.method1569(var3 + 4, (byte)-51) == 126) {
            var3 += 4;
         } else {
