...
final class Class3_Sub11 extends Node {
   ...
   private VertexBuffer aClass156_2363;
   ...
   final void method145() {
      ...
      this.aClass130_2353 = new Hashtable(Class95.method1585(this.anInt2342));
   ...
   final int method146(int var1, int var2, int var3, float var4, float var5, float var6, int var7, float var8) {
      ...
      if(var9 != 0L) {
         this.aClass130_2353.put(new IntegerNode(this.anInt2343), var9);
      }
   ...
   final void method148() {
      ...
      for(int var2 = 0; var2 < this.anInt2343; ++var2) {
         if(HDToolkit.isBigEndianOrder) {
            ...
            var1.putInt(this.anIntArray2348[var2]);
            ...
            var1.method762((float)this.anIntArray2371[var2]);
            var1.method762((float)this.anIntArray2358[var2]);
            var1.method762((float)this.anIntArray2352[var2]);
            var1.putInt(this.anIntArray2348[var2]);
            var1.method762(this.aFloatArray2369[var2]);
            var1.method762(this.aFloatArray2365[var2]);
            var1.method762(this.aFloatArray2354[var2]);
            var1.method762((float)this.anIntArray2371[var2] / this.aFloat2373);
            var1.method762((float)this.anIntArray2352[var2] / this.aFloat2373);
            if(this.aBoolean2347) {
               var1.method762(this.aFloatArray2346[var2]);
            }
         }
      }

      if(HDToolkit.isBufferAnObject) {
         ByteBuffer var3 = ByteBuffer.wrap(var1.buf, 0, var1.pos);
         this.aClass156_2363 = new VertexBuffer();
         this.aClass156_2363.method2172(var3);
      } else {
         this.aByteBuffer2345 = ByteBuffer.allocateDirect(var1.pos).order(ByteOrder.nativeOrder());
         this.aByteBuffer2345.put(var1.buf, 0, var1.pos);
   ...
   final void method149(GroundTile[][][] var1, float var2, boolean var3) {
      if(aClass3_Sub30_2372 != null && aClass3_Sub30_2372.buf.length >= this.anInt2359 * 4) {
         aClass3_Sub30_2372.pos = 0;
      } else {
         aClass3_Sub30_2372 = new Buffer(this.anInt2359 * 4);
      }

      if(aClass3_Sub30_2362 != null && aClass3_Sub30_2362.buf.length >= this.anInt2356 * 4) {
         aClass3_Sub30_2362.pos = 0;
      } else {
         ...
         for(var4 = 0; var4 < this.anInt2366; ++var4) {
            ...
            if(var5 != null && var5.aBoolean2222) {
               ...
               if(this.aBoolean2364) {
                  ...
                  if(var8 != null) {
                     for(var9 = 0; var9 < var8.length; ++var9) {
                        aClass3_Sub30_2362.putInt(var8[var9]);
                     }
                  }
               ...
               for(var12 = 1; var12 < var7.length - 1; ++var12) {
                  var6.putInt(var7[0]);
                  var6.putInt(var7[var12]);
                  var6.putInt(var7[var12 + 1]);
               }
            }
         }
      } else {
         for(var4 = 0; var4 < this.anInt2366; ++var4) {
            ...
            if(var5 != null && var5.aBoolean2222) {
               ...
               if(this.aBoolean2364) {
                  ...
                  if(var8 != null) {
                     for(var9 = 0; var9 < var8.length; ++var9) {
                        aClass3_Sub30_2362.putLEInt(var8[var9]);
                     }
                  }
               ...
               for(var12 = 1; var12 < var7.length - 1; ++var12) {
                  var6.putLEInt(var7[0]);
                  var6.putLEInt(var7[var12]);
                  var6.putLEInt(var7[var12 + 1]);
               }
            }
         }
      }

      if(aClass3_Sub30_2372.pos != 0 || aClass3_Sub30_2362.pos != 0) {
         GL var10 = HDToolkit.gl;
         if(this.anInt2351 != -1 && !var3) {
            Rasterizer.anInterface2_838.method8(this.anInt2351, true);
         } else {
         ...
         if(aClass3_Sub30_2372.pos != 0) {
            if(aByteBuffer2368 != null && aByteBuffer2368.capacity() >= aClass3_Sub30_2372.pos) {
               aByteBuffer2368.clear();
            } else {
               aByteBuffer2368 = ByteBuffer.allocateDirect(aClass3_Sub30_2372.pos).order(ByteOrder.nativeOrder());
            }

            aByteBuffer2368.put(aClass3_Sub30_2372.buf, 0, aClass3_Sub30_2372.pos);
            aByteBuffer2368.flip();
            HDToolkit.method1832(var2);
            var10.glDrawElements(4, aClass3_Sub30_2372.pos / 4, 5125, aByteBuffer2368);
         }

         if(aClass3_Sub30_2362.pos != 0) {
            if(aByteBuffer2361 != null && aByteBuffer2361.capacity() >= aClass3_Sub30_2362.pos) {
               aByteBuffer2361.clear();
            } else {
               aByteBuffer2361 = ByteBuffer.allocateDirect(aClass3_Sub30_2362.pos).order(ByteOrder.nativeOrder());
            }

            aByteBuffer2361.put(aClass3_Sub30_2362.buf, 0, aClass3_Sub30_2362.pos);
            aByteBuffer2361.flip();
            HDToolkit.method1832(var2 - 100.0F);
            HDToolkit.disableDepthBuffer();
            var10.glDrawElements(4, aClass3_Sub30_2362.pos / 4, 5125, aByteBuffer2361);
