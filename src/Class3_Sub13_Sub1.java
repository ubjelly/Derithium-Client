...
final class Class3_Sub13_Sub1 extends Class3_Sub13 {
   ...
   static PacketBuffer outputStream = new PacketBuffer(5000);
   private int anInt3036 = 0;
   private int anInt3037 = 1;
   private int anInt3038 = 0;
   static jString aClass94_3039 = jString.createJString("0");
   static jString aClass94_3040 = jString.createJString("<col=40ff00>");
   static AnimationLoader[] aClass3_Sub28_Sub5Array3041 = new AnimationLoader[14];
   ...
   public static void method168(int var0) {
      try {
         aClass94_3040 = null;
         if(var0 != -1771542303) {
            aClass3_Sub28_Sub5Array3041 = (AnimationLoader[])null;
         }
      ...
      try {
         ...
         if(this.aClass114_2382.aBoolean1580) {
            ...
            for(int var6 = 0; var6 < Class113.anInt1559; ++var6) {
               int var8 = TextureLoader.anIntArray2125[var6];
   ...
   static final void method171(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      try {
         ...
         if(Canvas_Sub2.loadInterface(var1)) {
            Class47.method1095(var2, var8, var4, SceneGraphNode.interfaceCache[var1], var3, -1, var7, var6, (byte)119, var5);
         } else {
            if(~var5 != 0) {
               GroundItem.aBooleanArray3674[var5] = true;
            } else {
               for(int var9 = 0; -101 < ~var9; ++var9) {
                  GroundItem.aBooleanArray3674[var9] = true;
               }
            }
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         ...
         if(-1 != ~var1) {
            if(1 == var1) {
               this.anInt3036 = var2.getUByte();
            } else if(~var1 == -4) {
               this.anInt3037 = var2.getUByte();
            }
         } else {
            this.anInt3038 = var2.getUByte();
         }
