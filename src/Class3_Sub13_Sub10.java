...
final class Class3_Sub13_Sub10 extends Class3_Sub13 {
   ...
   private static jString aClass94_3120 = jString.createJString("M");
   static Frame fullscreenFrame;
   //static jString aClass94_3123 = jString.createJString("::noclip");
   static jString aClass94_3124 = aClass94_3120;
   static Signlink errorSignlink;
   private int anInt3126 = 2048;
   private int anInt3127 = 3072;
   private int anInt3128 = 1024;
 static jString aClass94_3117 = aClass94_3120;
   ...
   static final int method210(int var0, int var1, int var2, int var3) {
      try {
         if(~var2 == ~var3) {
            ...
            int var4 = -var1 + 128;
            if(var0 != 18348) {
               method213(82, -103, 50, -59, (SceneGraphNode)null, 126L, (SceneGraphNode)null, (SceneGraphNode)null);
            }
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         if(var1 != 0) {
            if(var1 == 1) {
               this.anInt3127 = var2.getUShort();
            } else if(-3 == ~var1) {
               this.aBoolean2375 = var2.getUByte() == 1;
            }
         } else {
            this.anInt3128 = var2.getUShort();
         }

         if(!var3) {
            this.method157(56, (Buffer)null, true);
         }
   ...
   static final void method212(long var0, int var2) {
      try {
         if(0L != var0) {
            for(int var3 = var2; ~var3 > ~AnimationLoader.anInt3591; ++var3) {
               if(Class114.aLongArray1574[var3] == var0) {
                  ++Class137.anInt1781;
                  --AnimationLoader.anInt3591;

                  for(int var4 = var3; ~AnimationLoader.anInt3591 < ~var4; ++var4) {
                  ...
                  Class3_Sub13_Sub1.outputStream.putPacket(214);
   ...
   static final void method213(int var0, int var1, int var2, int var3, SceneGraphNode var4, long var5, SceneGraphNode var7, SceneGraphNode var8) {
      ...
      int var10 = 0;
      GroundTile var11 = Class75_Sub2.groundTiles[var0][var1][var2];
      if(var11 != null) {
      ...
      Class75_Sub2.groundTiles[var0][var1][var2].aClass72_2245 = var9;
   }

   static final void method214(SceneGraphNode var0, int var1, int var2, int var3, int var4, int var5) {
      boolean var6 = true;
      int var7 = var2;
      int var8 = var2 + var4;
      int var9 = var3 - 1;
      ...
      for(int var11 = var1; var11 <= var1 + 1; ++var11) {
         if(var11 != TransformList.anInt2456) {
            for(int var12 = var7; var12 <= var8; ++var12) {
               if(var12 >= 0 && var12 < jSocket.anInt1234) {
                  for(int var13 = var9; var13 <= var10; ++var13) {
                     if(var13 >= 0 && var13 < Class3_Sub13_Sub15.anInt3179 && (!var6 || var12 >= var8 || var13 >= var10 || var13 < var3 && var12 != var2)) {
                        GroundTile var14 = Class75_Sub2.groundTiles[var11][var12][var13];
                        if(var14 != null) {
