...
final class Class3_Sub13_Sub16 extends Class3_Sub13 {
   ...
   static jString aClass94_3190 = jString.createJString("<img=1>");
   private int anInt3191 = 2;
   static jString aClass94_3192 = jString.createJString(" ");
   private int anInt3193 = 2048;
   private int anInt3194 = 1;
   private byte[] aByteArray3195 = new byte[512];
   static jString aClass94_3196 = jString.createJString("Fps:");
         ...
         if(var1 == 37) {
            if(0 < this.anInt3193) {
               for(int var3 = 0; 512 > var3; ++var3) {
                  this.aShortArray3200[var3] = (short)OverlayType.method1603(var2, this.anInt3193);
               }
            }
   ...
   static final int method243(jString var0, byte var1) {
      try {
         if(var1 != 13) {
            method245(-29);
         }
         ...
         for(int var2 = 0; ~var2 > ~Class3_Sub13_Sub19.aClass94Array3238.length; ++var2) {
            if(Class3_Sub13_Sub19.aClass94Array3238[var2].method1531(var0)) {
               return var2;
            }
         }
      ...
      try {
         ...
         if(this.aClass114_2382.aBoolean1580) {
            ...
            for(int var15 = 0; var15 < Class113.anInt1559; ++var15) {
               ...
               KeyboardHandler.anInt1914 = Integer.MAX_VALUE;
               LookupTable.anInt1042 = Integer.MAX_VALUE;
               AnimationLoader.anInt3589 = Integer.MAX_VALUE;
               int var16 = this.anInt3203 * TextureLoader.anIntArray2125[var15] + 2048;
               int var17 = var16 >> 12;
               int var18 = 1 + var17;
               ...
               for(int var9 = var6 - 1; ~var9 >= ~var7; ++var9) {
                  ...
                  for(int var8 = var17 + -1; var18 >= var8; ++var8) {
                     ...
                     if(var12 >= AnimationLoader.anInt3589) {
                        if(~var12 > ~LookupTable.anInt1042) {
                           Class3_Sub13_Sub36.anInt3422 = KeyboardHandler.anInt1914;
                           KeyboardHandler.anInt1914 = LookupTable.anInt1042;
                           LookupTable.anInt1042 = var12;
                        } else if(KeyboardHandler.anInt1914 <= var12) {
                           if(var12 < Class3_Sub13_Sub36.anInt3422) {
                              Class3_Sub13_Sub36.anInt3422 = var12;
                           }
                        } else {
                           Class3_Sub13_Sub36.anInt3422 = KeyboardHandler.anInt1914;
                           KeyboardHandler.anInt1914 = var12;
                        }
                     } else {
                        Class3_Sub13_Sub36.anInt3422 = KeyboardHandler.anInt1914;
                        KeyboardHandler.anInt1914 = LookupTable.anInt1042;
                        LookupTable.anInt1042 = AnimationLoader.anInt3589;
                        AnimationLoader.anInt3589 = var12;
                     }
                  }
               }
               ...
               if(-1 == ~var19) {
                  var3[var15] = AnimationLoader.anInt3589;
               } else if(var19 != 1) {
                  if(-4 == ~var19) {
                     var3[var15] = KeyboardHandler.anInt1914;
                  } else if(var19 == 4) {
                     var3[var15] = Class3_Sub13_Sub36.anInt3422;
                  } else if(-3 == ~var19) {
                     var3[var15] = LookupTable.anInt1042 + -AnimationLoader.anInt3589;
                  }
               } else {
                  var3[var15] = LookupTable.anInt1042;
               }
            }
         }
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         if(!var3) {
            this.method157(-122, (Buffer)null, false);
         }

         if(-1 == ~var1) {
            this.anInt3203 = this.anInt3204 = var2.getUByte();
         } else if(-2 == ~var1) {
            this.anInt3197 = var2.getUByte();
         } else if(2 != var1) {
            if(-4 == ~var1) {
               this.anInt3191 = var2.getUByte();
            } else if(var1 == 4) {
               this.anInt3194 = var2.getUByte();
            } else if(var1 == 5) {
               this.anInt3203 = var2.getUByte();
            } else if(var1 == 6) {
               this.anInt3204 = var2.getUByte();
            }
         } else {
            this.anInt3193 = var2.getUShort();
         }
