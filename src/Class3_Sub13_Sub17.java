...
final class Class3_Sub13_Sub17 extends Class3_Sub13 {
   ...
   //static jString aClass94_3209 = jString.createJString("showingVideoAd");
   static js5 aClass153_3210;
   static jString aClass94_3211 = jString.createJString(" <col=ffffff>");
   ...
   static final void method246(int var0) {
      try {
         ...
         PacketBuffer.method813();
         GrandExchangeItem.method1803((byte)22);
         Class38.method1025();
         Class40.method1044(-3782);
         Node.method85((byte)-114);
         ProducingGraphicsBuffer.method2192(-68);
         Class159.method2196(128);
         Vertex.method1132(103);
         ...
         InterfaceChangeNode.h((byte)3);
         Class107.method1650(21);
         MouseHandler.method2089((byte)115);
         Class3_Sub13_Sub11.aClass93_3130.clearSoftReference();
         Class80.aClass93_1135.clearSoftReference();
   ...
   static final void method247(byte var0) {
      try {
         ...
         if(Class140_Sub2.titleScreenLoaded) {
            ...
            Class140_Sub2.titleScreenLoaded = false;
   ...
   private final void method248(int var1, byte var2, int var3) {
      try {
         if(var2 > 80) {
            ...
            Class159.anInt2024 &= client.anInt396;
            Vertex.anInt828 &= Class3_Sub20.anInt2487;
         }
   ...
   static final void method250(int var0, js5 var1) {
      try {
         if(var0 == 2048) {
   ...
   static final void method252(int var0) {
      try {
         Class3_Sub9 var1;
         for(var1 = (Class3_Sub9)Node.aClass61_78.getFirst(); null != var1; var1 = (Class3_Sub9)Node.aClass61_78.getNext()) {
            if(var1.aBoolean2329) {
               var1.method134(1);
            }
         }

         for(var1 = (Class3_Sub9)jSocket.aClass61_1242.getFirst(); null != var1; var1 = (Class3_Sub9)jSocket.aClass61_1242.getNext()) {
            if(var1.aBoolean2329) {
               var1.method134(1);
            }
         }
      ...
      try {
         ...
         if(this.aClass114_2382.aBoolean1580) {
            for(int var5 = 0; var5 < Class113.anInt1559; ++var5) {
               ...
               int[] var6 = this.method152(0, Vertex.anInt828, 32755);
      ...
      try {
         ...
         if(this.aClass97_2376.aBoolean1379) {
            ...
            for(int var7 = 0; Class113.anInt1559 > var7; ++var7) {
               ...
               int[][] var8 = this.method162(Vertex.anInt828, 0, (byte)-49);
