...
final class Class3_Sub13_Sub20 extends Class3_Sub13 {
   ...
   private static jString aClass94_3247 = jString.createJString("flash1:");
   static jString aClass94_3249 = aClass94_3247;
   private int anInt3250 = 4096;
   private int anInt3252 = 4096;
static jString aClass94_3246 = aClass94_3247;
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         if(-1 != ~var1) {
            if(var1 != 1) {
               if(2 == var1) {
                  this.anInt3250 = var2.getUShort();
               }
            } else {
               this.anInt3245 = var2.getUShort();
            }
         } else {
            this.anInt3252 = var2.getUShort();
         }
