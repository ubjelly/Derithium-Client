...
final class Class3_Sub13_Sub21 extends Class3_Sub13 {
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         if(~var1 == -1) {
            this.anInt3265 = var2.getUShort();
         } else if(var1 == 1) {
            this.anInt3253 = var2.getUShort();
         } else if(-3 == ~var1) {
            this.anInt3258 = var2.getUShort();
         } else if(var1 != 3) {
            if(var1 != 4) {
               if(-6 == ~var1) {
                  this.anInt3254 = var2.getUShort();
               } else if(var1 == 6) {
                  this.anInt3266 = var2.getUShort();
               }
            } else {
               this.anInt3257 = var2.getUShort();
            }
         } else {
            this.anInt3262 = var2.getUShort();
         }
         ...
         if(Canvas_Sub1.anInt23 != 0) {
            try {
               ...
               if(3 == Canvas_Sub1.anInt23) {
                  ...
                  Class3_Sub13_Sub33.aClass94Array3391 = new jString[Class3_Sub15.worldConnection.read()];
                  Canvas_Sub1.anInt23 = 4;
               }

               if(~Canvas_Sub1.anInt23 == -5) {
                  if(~Class3_Sub15.worldConnection.available() > ~(8 * Class3_Sub13_Sub33.aClass94Array3391.length)) {
                     return;
                  }

                  SpotAnimation.aClass3_Sub30_Sub1_532.pos = 0;
                  Class3_Sub15.worldConnection.read(SpotAnimation.aClass3_Sub30_Sub1_532.buf, 0, 8 * Class3_Sub13_Sub33.aClass94Array3391.length);

                  for(var1 = 0; ~Class3_Sub13_Sub33.aClass94Array3391.length < ~var1; ++var1) {
                     Class3_Sub13_Sub33.aClass94Array3391[var1] = FileSystem.longToString(SpotAnimation.aClass3_Sub30_Sub1_532.getLong());
                  }
   ...
   static final void method269(int var0, int var1) {
      try {
         ...
         Deque.aClass93_939.method1522(var1);
      } catch (RuntimeException var3) {
      ...
      try {
         ...
         if(this.aClass114_2382.aBoolean1580) {
            ...
            for(int var6 = 0; var6 < Class113.anInt1559; ++var6) {
               ...
               int var7 = TextureLoader.anIntArray2125[var6] + -2048;
      ...
      try {
         ...
         for(int var2 = 0; var2 < var1; ++var2) {
            if(Class3_Sub13_Sub26.aByteArrayArray3335[var2] != null) {
               ...
               int var5 = 0;
               Buffer var16 = new Buffer(Class3_Sub13_Sub26.aByteArrayArray3335[var2]);

               while(~var16.pos > ~Class3_Sub13_Sub26.aByteArrayArray3335[var2].length && 511 > var5) {
                  int var6 = var5++ << 6 | var3;
                  int var7 = var16.getUShort();
                  int var8 = var7 >> 14;
                  int var9 = 63 & var7 >> 7;
                  ...
                  NpcDefinition var13 = NpcDefinition.list(var16.getUShort());
                  if(Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292[var6] == null && (var13.aByte1267 & 1) > 0 && ~var8 == ~Class140_Sub3.anInt2745 && -1 >= ~var11 && 104 > var13.size + var11 && ~var12 <= -1 && 104 > var12 - -var13.size) {
                     Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292[var6] = new Npc();
                     Npc var14 = Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292[var6];
                     Class15.anIntArray347[Class163.anInt2046++] = var6;
                     var14.anInt2838 = Class44.loopCycle;
                     var14.method1987(-1, var13);
                     var14.setSize(var14.aClass90_3976.size, 2);
                     var14.turnDirection = var14.directionDegrees = Class27.anIntArray510[var14.aClass90_3976.aByte1268];
                     var14.anInt2779 = var14.aClass90_3976.anInt1274;
                     if(~var14.anInt2779 == -1) {
                        var14.directionDegrees = 0;
                     }

                     var14.method1967(var14.getSize(), var11, var12, true);
                  }
               }
            }
         }
