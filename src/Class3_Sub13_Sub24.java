...
final class Class3_Sub13_Sub24 extends Class3_Sub13 {
   ...
   static Npc[] aClass140_Sub4_Sub2Array3292 = new Npc['\u8000'];
   static int anInt3293 = 0;
   private int anInt3294 = 1;
   static jString aClass94_3295;
   static long aLong3296 = 0L;
   private int anInt3297 = 1;
   static jString aClass94_3298 = jString.createJString("<col=ff0000>");
         ...
         if(this.aClass114_2382.aBoolean1580) {
            ...
            for(var10 = -this.anInt3297 + var1; ~var10 >= ~(var1 - -this.anInt3297); ++var10) {
               ...
               for(var14 = -this.anInt3294; ~this.anInt3294 <= ~var14; ++var14) {
                  var13 += var11[var14 & client.anInt396];
               }

               for(var14 = 0; ~Class113.anInt1559 < ~var14; var13 += var11[client.anInt396 & this.anInt3294 + var14]) {
                  var12[var14] = var8 * var13 >> 16;
                  var13 -= var11[client.anInt396 & var14 - this.anInt3294];
                  ++var14;
               }
   ...
   public Class3_Sub13_Sub24() {
	...
	static final void dropClient() {
		if (Class159.logoutCycle > 0) {
			...
			Class163_Sub2_Sub1.worldConnection2 = Class3_Sub15.worldConnection;
         ...
         if(this.aClass97_2376.aBoolean1379) {
            ...
            for(int var9 = var2 - this.anInt3297; this.anInt3297 + var2 >= var9; ++var9) {
               ...
               for(int var18 = -this.anInt3294; var18 <= this.anInt3294; ++var18) {
                  int var19 = var18 & client.anInt396;
                  var13 += var16[var19];
                  var12 += var15[var19];
                  var14 += var17[var19];
               }
               ...
               for(int var21 = 0; Class113.anInt1559 > var21; var12 += var15[var22]) {
                  ...
                  var22 = client.anInt396 & var21 + -this.anInt3294;
                  var14 -= var17[var22];
                  ++var21;
                  var12 -= var15[var22];
                  var13 -= var16[var22];
                  var22 = this.anInt3294 + var21 & client.anInt396;
                  var14 += var17[var22];
                  var13 += var16[var22];
               }
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         if(~var1 == -1) {
            this.anInt3294 = var2.getUByte();
         } else if(var1 != 1) {
            if(2 == var1) {
               this.aBoolean2375 = var2.getUByte() == 1;
            }
         } else {
            this.anInt3297 = var2.getUByte();
         }
