...
final class Class3_Sub13_Sub25 extends Class3_Sub13 {
   ...
   static js5Worker cacheIndex10;
   static int loginStage = 0;
   private static jString aClass94_3306 = jString.createJString(" is already on your ignore list)3");
   static jString aClass94_3307 = jString.createJString("<col=00ff80>");
   private int anInt3308 = 2048;
   private int anInt3309 = 0;
   private int anInt3310 = 409;
   static jString aClass94_3311 = aClass94_3306;
   ...
   final void method158(int var1) {
      try {
         if(var1 != 16251) {
            this.method157(-7, (Buffer)null, true);
         }
      ...
      try {
         ...
         if(this.aClass114_2382.aBoolean1580) {
            ...
            if(var18 <= 1) {
               ...
               while(true) {
                  while(true) {
                     int var24 = var15 - -OverlayType.method1603(var22, var16 - var15);
                     int var25 = OverlayType.method1603(var22, -var17 + var18) + var17;
                     ...
                     if(~var26 == ~Class113.anInt1559) {
                        ...
                        var40[2] = var25 + var23;
                        var40[1] = var26;
                        var7 = OverlayType.method1603(var22, Class113.anInt1559);
                        var6 = var7 + -var8;
                        int[][] var41 = var21;
                        var9 = 0;
                        var21 = var20;
   ...
   private final void method291(int var1, Random var2, int var3, int var4, byte var5, int var6, int[][] var7) {
      try {
         if(var5 == -69) {
            int var8 = -1 > ~this.anInt3316?4096 + -OverlayType.method1603(var2, this.anInt3316):4096;
            int var9 = this.anInt3299 * this.anInt3314 >> 12;
            int var10 = this.anInt3314 - (0 < var9?OverlayType.method1603(var2, var9):0);
                  ...
                  if(~var17 > ~var14) {
                     ...
                     if(~this.anInt3309 != -1) {
                        for(var20 = 0; var20 < var13; ++var20) {
                           ...
                           var18[ClientScript.method633(client.anInt396, var3 - -var20)] = var18[ClientScript.method633(client.anInt396, var4 + var3 + -var20 - 1)] = ~var19 >= ~var21?var19:var21;
                        }
                     } else {
                        for(var20 = 0; ~var13 < ~var20; ++var20) {
                           var21 = var20 * var8 / var13;
                           var18[ClientScript.method633(client.anInt396, var20 + var3)] = var18[ClientScript.method633(-1 + var4 + var3 + -var20, client.anInt396)] = var21 * var19 >> 12;
                        }
                     }
                     ...
                     if(~var19 <= ~var14) {
                        for(var20 = 0; var13 > var20; ++var20) {
                           var18[ClientScript.method633(client.anInt396, var3 + var20)] = var18[ClientScript.method633(-1 + -var20 + var3 - -var4, client.anInt396)] = var8 * var20 / var13;
                        }
                        ...
                        if(this.anInt3309 == 0) {
                           for(var21 = 0; var13 > var21; ++var21) {
                              ...
                              var18[ClientScript.method633(client.anInt396, var3 - -var21)] = var18[ClientScript.method633(client.anInt396, -1 + var3 - (-var4 + var21))] = var22 * var20 >> 12;
                           }
                        } else {
                           for(var21 = 0; ~var13 < ~var21; ++var21) {
                              var22 = var21 * var8 / var13;
                              var18[ClientScript.method633(var3 - -var21, client.anInt396)] = var18[ClientScript.method633(-1 + -var21 + var4 + var3, client.anInt396)] = ~var20 >= ~var22?var20:var22;
                           }
                        }
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         ...
         if(~var1 != -1) {
            if(var1 == 1) {
               this.anInt3300 = var2.getUShort();
            } else if(2 != var1) {
               if(var1 != 3) {
                  if(-5 == ~var1) {
                     this.anInt3301 = var2.getUShort();
                  } else if(var1 != 5) {
                     if(-7 != ~var1) {
                        if(-8 != ~var1) {
                           if(~var1 == -9) {
                              this.anInt3316 = var2.getUShort();
                           }
                        } else {
                           this.anInt3299 = var2.getUShort();
                        }
                     } else {
                        this.anInt3309 = var2.getUByte();
                     }
                  } else {
                     this.anInt3303 = var2.getUShort();
                  }
               } else {
                  this.anInt3310 = var2.getUShort();
               }
            } else {
               this.anInt3308 = var2.getUShort();
            }
         } else {
            this.anInt3312 = var2.getUByte();
         }
   ...
   static final boolean method292(int var0, int var1, int var2, int var3, SceneGraphNode var4, int var5, long var6, int var8, int var9, int var10, int var11) {
