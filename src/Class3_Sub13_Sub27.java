...
final class Class3_Sub13_Sub27 extends Class3_Sub13 {
   ...
   static jString aClass94_3339 = jString.createJString("null");
   static int anInt3340;
   static jString[] aClass94Array3341 = new jString[100];
   static int anInt3342;
   private int anInt3343 = 6;


   static final void method295(jString var0, byte var1, int var2) {
      try {
         InterfaceChangeNode var3 = Class3_Sub24_Sub3.putInterfaceChange(2, var2);
         if(var1 != 40) {
            method299(22, -104);
         }

         var3.add();
         var3.stringValue = var0;
   ...
   final int[][] method166(int var1, int var2) {
      try {
         if(var1 != -1) {
            this.method157(-8, (Buffer)null, false);
         }
   ...
   static final void method297(long var0) {
         if(var0 != 0L) {
            for(int var3 = 0; ~var3 > ~Class8.anInt104; ++var3) {
               if(~Vertex.aLongArray826[var3] == ~var0) {
                  --Class8.anInt104;

                  for(int var4 = var3; var4 < Class8.anInt104; ++var4) {
                     Class70.aClass94Array1046[var4] = Class70.aClass94Array1046[var4 - -1];
                     CursorType.anIntArray882[var4] = CursorType.anIntArray882[var4 + 1];
                     NodeSub.aClass94Array2566[var4] = NodeSub.aClass94Array2566[1 + var4];
                     Vertex.aLongArray826[var4] = Vertex.aLongArray826[1 + var4];
                  ...
                  jString class26 = FileSystem.longToString(var0).upperCase();
                  Class3_Sub13_Sub1.outputStream.putPacket(133);
                  Class3_Sub13_Sub1.outputStream.putString(class26);
                  break;
            }
            }
         }
      ...
      try {
         ...
         for(int var16 = 1; var16 <= 103; ++var16) {
            for(var17 = 1; var17 <= 103; ++var17) {
               ...
               if(0 != var18) {
                  OverlayType var19 = OverlayType.list(-1 + (255 & var18));
         ...
         Class3_Sub11 var54;
         for(var54 = (Class3_Sub11)var52.getFirst(); var54 != null; var54 = (Class3_Sub11)var52.getNext()) {
            var54.method145();
         }
         ...
         for(var17 = 1; -103 <= ~var17; ++var17) {
            for(var56 = 1; -103 <= ~var56; ++var56) {
               ...
               if(0 != var57) {
                  ...
                  Class25.method955(var13, var64 <= var64, Class3_Sub13_Sub4.method190(var46, var38, var42), var50, var58, var56, var20, var17, var64 <= var63, var8, var69 >= var64, 2, var4, var22, Class3_Sub13_Sub4.method190(var46, var41, var45), Class3_Sub13_Sub4.method190(var46, var40, var44), ~var64 >= ~var62, var12, var10, var61, Class3_Sub13_Sub4.method190(var46, var39, var43), var60);
                  int var49 = (var69 >> 16) - 1;
                  if(var32 != var67) {
                     var50 = (Class3_Sub11)var52.get(var32);
                     Class25.method955(var13, var62 <= var64, Class3_Sub13_Sub4.method190(var47, var38, var42), var50, var58, var56, var20, var17, var63 >= var62, var8, var62 <= var69, 2, var4, var22, Class3_Sub13_Sub4.method190(var47, var41, var45), Class3_Sub13_Sub4.method190(var47, var40, var44), var62 <= var62, var12, var10, var61, Class3_Sub13_Sub4.method190(var47, var39, var43), var60);
                  }

                  if(var70 != var67 && ~var70 != ~var32) {
                     var50 = (Class3_Sub11)var52.get(var70);
                     Class25.method955(var13, ~var64 <= ~var63, Class3_Sub13_Sub4.method190(var48, var38, var42), var50, var58, var56, var20, var17, var63 <= var63, var8, var63 <= var69, var14 ^ 4098, var4, var22, Class3_Sub13_Sub4.method190(var48, var41, var45), Class3_Sub13_Sub4.method190(var48, var40, var44), ~var62 <= ~var63, var12, var10, var61, Class3_Sub13_Sub4.method190(var48, var39, var43), var60);
                  }

                  if(~var36 != ~var67 && ~var36 != ~var32 && var36 != var70) {
                     var50 = (Class3_Sub11)var52.get(var36);
                     Class25.method955(var13, ~var69 >= ~var64, Class3_Sub13_Sub4.method190(var49, var38, var42), var50, var58, var56, var20, var17, var69 <= var63, var8, ~var69 <= ~var69, var14 ^ 4098, var4, var22, Class3_Sub13_Sub4.method190(var49, var41, var45), Class3_Sub13_Sub4.method190(var49, var40, var44), ~var62 <= ~var69, var12, var10, var61, Class3_Sub13_Sub4.method190(var49, var39, var43), var60);
                  }
               }
            }
         }
   ...
   static final void method299(int var1, int var2) {
         int var3 = var1;
         if(var1 > 25) {
            var3 = 25;
         }
         ...
         if(0 == var2) {
            Class3_Sub13_Sub1.outputStream.putPacket(50);
            Class3_Sub13_Sub1.outputStream.putByte(var3 + var3 + 3);
         }

         if(1 == var2) {
            Class3_Sub13_Sub1.outputStream.putPacket(143);
            Class3_Sub13_Sub1.outputStream.putByte(3 + var3 + (var3 + 14));
         }

         if(var2 == 2) {
            Class3_Sub13_Sub1.outputStream.putPacket(36);
            Class3_Sub13_Sub1.outputStream.putByte(var3 + var3 + 3);
         }

         Class3_Sub13_Sub1.outputStream.putByteS(ObjectDefinition.aBooleanArray1490[82]?1:0);
         Class3_Sub13_Sub1.outputStream.putLEShort(Class82.anInt1152 + var5);
         Class3_Sub13_Sub1.outputStream.putShortA(Class131.anInt1716 + var4);
         Class45.mapFlagY = Class45.anIntArray729[0];
         Class65.mapFlagX = Class3_Sub13_Sub38.anIntArray3456[0];

         for(int var6 = 1; var3 > var6; ++var6) {
            --var1;
            Class3_Sub13_Sub1.outputStream.putByteS(-var4 + Class3_Sub13_Sub38.anIntArray3456[var1]);
            Class3_Sub13_Sub1.outputStream.putByteS(Class45.anIntArray729[var1] + -var5);
         }
   }
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         if(var1 == 0) {
            this.anInt3343 = var2.getUByte();
         } else if(~var1 == -2) {
            this.aBoolean2375 = ~var2.getUByte() == -2;
         }

         if(!var3) {
            aClass94_3339 = (jString)null;
         }
