...
final class Class3_Sub13_Sub28 extends Class3_Sub13 {
   ...
   static js5Worker cacheIndex9;
   static jString aClass94_3353;
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         if(0 == var1) {
            this.anInt3350 = var2.getUShort();
         } else if(1 != var1) {
            if(~var1 == -3) {
               this.anInt3354 = var2.getUShort();
            }
         } else {
            this.anInt3347 = var2.getUShort();
         }
      ...
      try {
         ...
         if(this.aClass114_2382.aBoolean1580) {
            ...
            for(int var12 = 0; Class113.anInt1559 > var12; ++var12) {
               int var14 = (var10[client.anInt396 & -1 + var12] - var10[1 + var12 & client.anInt396]) * var8 >> 12;
   ...
   static final void method302(int var0) {
      try {
         ...
         for(Class3_Sub28_Sub19 var1 = (Class3_Sub28_Sub19)Class3_Sub13_Sub30.aClass61_3364.getFirst(); var1 != null; var1 = (Class3_Sub28_Sub19)Class3_Sub13_Sub30.aClass61_3364.getNext()) {
            Class140_Sub6 var2 = var1.aClass140_Sub6_3778;
            if(~Class26.plane == ~var2.anInt2907 && ~var2.anInt2899 <= ~Class44.loopCycle) {
               if(Class44.loopCycle >= var2.anInt2925) {
                  if(-1 > ~var2.anInt2919) {
                     Npc var3 = Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292[-1 + var2.anInt2919];
                     if(null != var3 && var3.anInt2819 >= 0 && 13312 > var3.anInt2819 && var3.anInt2829 >= 0 && -13313 < ~var3.anInt2829) {
                        var2.method2024(var3.anInt2829, 1, Class44.loopCycle, Class121.method1736(var2.anInt2907, 1, var3.anInt2819, var3.anInt2829) + -var2.anInt2903, var3.anInt2819);
                     }
                  }
                  ...
                  if(var2.anInt2919 < 0) {
                     ...
                     Player var6;
                     if(ClickMaskNode.anInt2211 == var4) {
                        var6 = TextureLoader.selfPlayer;
                     } else {
                     ...
                     if(null != var6 && var6.anInt2819 >= 0 && ~var6.anInt2819 > -13313 && var6.anInt2829 >= 0 && ~var6.anInt2829 > -13313) {
                        var2.method2024(var6.anInt2829, 1, Class44.loopCycle, Class121.method1736(var2.anInt2907, 1, var6.anInt2819, var6.anInt2829) - var2.anInt2903, var6.anInt2819);
                     }
                  }

                  var2.method2023((byte)-59, DisplayModeInformation.anInt1446);
                  Class20.method907(Class26.plane, (int)var2.aDouble2920, (int)var2.aDouble2900, (int)var2.aDouble2914, 60, var2, var2.anInt2924, -1L, false);
               }
            } else {
               var1.unlink();
            }
