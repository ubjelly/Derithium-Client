...
final class Class3_Sub13_Sub32 extends Class3_Sub13 {
   ...
   private static jString aClass94_3386 = jString.createJString("Use");
   static boolean aBoolean3387 = true;
   static jString aClass94_3388 = aClass94_3386;
   ...
   static final void method320(int var0, int var1, int var2, byte var3, int var4) {
      try {
         if(~var4 >= ~var2) {
            Class3_Sub13_Sub23_Sub1.method282(Class38.anIntArrayArray663[var1], var4, var2, var0);
         } else {
            Class3_Sub13_Sub23_Sub1.method282(Class38.anIntArrayArray663[var1], var2, var4, var0);
         }
      ...
      try {
         ...
         if(this.aClass114_2382.aBoolean1580) {
            ...
            for(int var6 = 0; ~Class113.anInt1559 < ~var6; ++var6) {
               int var7 = TextureLoader.anIntArray2125[var6];
               int var8;
