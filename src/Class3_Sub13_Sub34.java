...
final class Class3_Sub13_Sub34 extends Class3_Sub13 {
                  ...
                  for(int var13 = 0; ~var13 > -65; ++var13) {
                     if(!var3 || ~(var4 * 8) >= ~var12 && 8 + 8 * var4 > var12 && var13 >= var5 * 8 && 8 + var5 * 8 > var13) {
                        ...
                        if(var2 != 0) {
                           ...
                           if(null == InterfaceListener.aByteArrayArrayArray2452[var10][var11]) {
                              InterfaceListener.aByteArrayArrayArray2452[var10][var11] = new byte[4096];
                           }

                           InterfaceListener.aByteArrayArrayArray2452[var10][var11][var12 + (-var13 + 63 << 6)] = var14;
                        }
                     }
                  }
               }
   ...
   static final void method329(int var0, int var1, int var2, int var3, byte var4, int var5, int var6, int var7) {
      try {
         ...
         if(var5 >= Class159.anInt2020 && Class57.anInt902 >= var5) {
            ...
            Class3_Sub13_Sub23_Sub1.method282(var40, var41, var43, var2);
            Class3_Sub13_Sub23_Sub1.method282(var40, var43, var44, var1);
            Class3_Sub13_Sub23_Sub1.method282(var40, var44, var42, var2);
         }
            ...
            if(Class159.anInt2020 <= var42 && Class57.anInt902 >= var41) {
               ...
               if(var49) {
                  ...
                  if(Class159.anInt2020 <= var41) {
                     ...
                     Class3_Sub13_Sub23_Sub1.method282(var47, var44, var46, var2);
                     Class3_Sub13_Sub23_Sub1.method282(var47, var46, var45, var1);
                     Class3_Sub13_Sub23_Sub1.method282(var47, var45, var43, var2);
                  }
                  ...
                  if(~Class159.anInt2020 >= ~var41) {
                     Class3_Sub13_Sub23_Sub1.method282(Class38.anIntArrayArray663[var41], var44, var43, var2);
                  }

                  if(Class57.anInt902 >= var42) {
                     Class3_Sub13_Sub23_Sub1.method282(Class38.anIntArrayArray663[var42], var44, var43, var2);
                  }
               }
            }
         }
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         if(var3) {
            if(var1 == 0) {
               this.anInt3404 = var2.getUShort();
            } else if(1 != var1) {
               if(~var1 == -3) {
                  this.anInt3406 = var2.getUShort();
               } else if(var1 != 3) {
                  if(4 == var1) {
                     int var4 = var2.getMidInt();
                     this.anIntArray3403[2] = ClientScript.method633(var4, 255) >> 12;
                     this.anIntArray3403[1] = ClientScript.method633(var4 >> 4, 4080);
                     this.anIntArray3403[0] = ClientScript.method633(16711680, var4) << 4;
                  }
               } else {
                  this.anInt3410 = var2.getUShort();
               }
            } else {
               this.anInt3405 = var2.getUShort();
            }
   ...
   static final void method330(int var0, int var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         if(var6 == 0) {
            ...
            SceneGraphNode.method1869((byte)6, var0, var11, var10, var9, var8);
         }
   ...
   public static void method333(byte var0) {
	...
	/*static final boolean method334(js5 var0) {
