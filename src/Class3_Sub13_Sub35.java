...
final class Class3_Sub13_Sub35 extends Class3_Sub13 {
   ...
   static jString aClass94_3418 = jString.createJString("(U5");
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         if(var3) {
            if(var1 == 0) {
               this.aBoolean2375 = -2 == ~var2.getUByte();
            }
   ...
   static final Class3_Sub28_Sub1 method336(int var0, byte var1) {
      try {
         ...
         if(null != var2) {
            ...
            byte[] var3;
            if(var0 < '\u8000') {
               var3 = Class47.aClass153_748.getFile(0, var0);
            } else {
               var3 = Queue.aClass153_332.getFile(0, var0 & 32767);
            }
