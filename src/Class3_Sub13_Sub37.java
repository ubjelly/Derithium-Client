...
final class Class3_Sub13_Sub37 extends Class3_Sub13 {
   ...
   static LDFont aClass3_Sub28_Sub17_Sub1_3440;
   static BigInteger aBigInteger3441 = new BigInteger("8784096651353199997452439564504785205116818155382223182025762557587092401706326230662806996238727283959643159575581225953287971213717511802074868210887121");
   ...
   private final void method345(int var1, boolean var2) {
      try {
         ...
         if(var2) {
            aClass3_Sub28_Sub17_Sub1_3440 = (LDFont)null;
         }
         ...
         if(var3) {
            if(var1 == 0) {
               ...
               if(-1 != ~var4) {
                  ...
                  this.anIntArrayArray3438 = new int[var2.getUByte()][4];

                  for(int var5 = 0; ~this.anIntArrayArray3438.length < ~var5; ++var5) {
                     this.anIntArrayArray3438[var5][0] = var2.getUShort();
                     this.anIntArrayArray3438[var5][1] = var2.getUByte() << 4;
                     this.anIntArrayArray3438[var5][2] = var2.getUByte() << 4;
                     this.anIntArrayArray3438[var5][3] = var2.getUByte() << 4;
                  }
               }
            }
   ...
   static final void method347(boolean var0) {
      try {
         ...
         int var1 = Class131.anInt1716 + (TextureLoader.selfPlayer.anInt2819 >> 7);
         int var2 = (TextureLoader.selfPlayer.anInt2829 >> 7) - -Class82.anInt1152;
   ...
   final int[][] method166(int var1, int var2) {
      try {
         ...
         if(var1 != -1) {
            this.method157(-71, (Buffer)null, false);
         }
         ...
         if(this.aClass97_2376.aBoolean1379) {
            ...
            for(int var9 = 0; Class113.anInt1559 > var9; ++var9) {
               ...
               var6[var9] = ClientScript.method633(var4, 16711680) >> 12;
               var7[var9] = ClientScript.method633(4080, var4 >> 4);
               var8[var9] = ClientScript.method633(255, var4) << 4;
            }
         }
   ...
   static final boolean method349(int var0, int var1, int var2) {
      for(int var3 = 0; var3 < PlainTile.anInt1672; ++var3) {
