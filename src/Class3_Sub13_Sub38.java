...
final class Class3_Sub13_Sub38 extends Class3_Sub13 {
   ...
   private static jString aClass94_3449 = jString.createJString("Loading sprites )2 ");
   private int anInt3450 = 4096;
   private int anInt3451 = 16;
   static jString aClass94_3452 = jString.createJString("mapmarker");
...
static jString aClass94_3445 = aClass94_3449;
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         if(-1 == ~var1) {
            this.anInt3454 = var2.getUByte();
         } else if(~var1 == -2) {
            this.anInt3447 = var2.getUShort();
         } else if(~var1 != -3) {
            if(3 == var1) {
               this.anInt3444 = var2.getUShort();
            } else if(var1 == 4) {
               this.anInt3450 = var2.getUShort();
            }
         } else {
            this.anInt3451 = var2.getUByte();
         }
      ...
      try {
         ...
         if(this.aClass114_2382.aBoolean1580) {
            ...
            for(int var8 = 0; this.anInt3447 > var8; ++var8) {
               int var9 = this.anInt3450 > 0?this.anInt3444 + -var5 + OverlayType.method1603(var7, this.anInt3450):this.anInt3444;
               int var10 = OverlayType.method1603(var7, Class113.anInt1559);
               var9 = (var9 & 4088) >> 4;
               int var11 = OverlayType.method1603(var7, Class101.anInt1427);
               ...
               if(~var15 != -1 || ~var14 != -1) {
                  ...
                  int var20 = -var18 / 2;
                  int var22 = -(OverlayType.method1603(var7, 4096) >> 2) + 1024;
                  ...
                  for(int var24 = var10; var12 > var24; ++var24) {
                     ...
                     int var26 = client.anInt396 & var24;
                     if(!var16) {
