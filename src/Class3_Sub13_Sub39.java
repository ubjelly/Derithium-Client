...
final class Class3_Sub13_Sub39 extends Class3_Sub13 {
   ...
   static AbstractSprite[] aClass3_Sub28_Sub16Array3458;
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         if(0 == var1) {
            this.anInt3462 = var2.getUByte();
            this.anIntArrayArray3469 = new int[var2.getUByte()][2];

            for(int var4 = 0; ~this.anIntArrayArray3469.length < ~var4; ++var4) {
               this.anIntArrayArray3469[var4][0] = var2.getUShort();
               this.anIntArrayArray3469[var4][1] = var2.getUShort();
            }
         }
