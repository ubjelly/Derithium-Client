...
final class Class3_Sub13_Sub4 extends Class3_Sub13 {
   ...
   static jString aClass94_3055 = jString.createJString("k");
   int anInt3056 = 4;
            ...
            if(-2 != ~this.anInt3058) {
               ...
               if(var9 > 8 || -8 > var9) {
                  ...
                  for(var10 = 0; Class113.anInt1559 > var10; ++var10) {
                     var4 = TextureLoader.anIntArray2125[var10] * this.anInt3060;
               ...
               if(this.aBoolean3065) {
                  for(var10 = 0; Class113.anInt1559 > var10; ++var10) {
                     var4 = this.anInt3060 * TextureLoader.anIntArray2125[var10];
   ...
   static final void method188(int var0, int var1) {
      try {
         ...
         Class154.aClass93_1955.method1522(var0);
   ...
   static final void method189(byte var0) {
      try {
         ...
         for(var1 = 0; ~Class163.anInt2046 < ~var1; ++var1) {
            ...
            Npc var6 = Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292[var2];
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         ...
         if(var1 == 0) {
            this.aBoolean3065 = var2.getUByte() == 1;
         } else if(~var1 == -2) {
            this.anInt3058 = var2.getUByte();
         } else if(var1 == 2) {
            this.anInt3062 = var2.getShort();
            if(0 > this.anInt3062) {
               this.aShortArray3066 = new short[this.anInt3058];

               for(int var4 = 0; this.anInt3058 > var4; ++var4) {
                  this.aShortArray3066[var4] = (short)var2.getShort();
               }
            }
         } else if(var1 == 3) {
            this.anInt3060 = this.anInt3056 = var2.getUByte();
         } else if(var1 == 4) {
            this.anInt3067 = var2.getUByte();
         } else if(~var1 == -6) {
            this.anInt3060 = var2.getUByte();
         } else if(var1 == 6) {
            this.anInt3056 = var2.getUByte();
         }
   ...
   static final int method190(int var0, int var1, int var3) {
         int var5 = Rasterizer.anIntArray834[LDModel.blendColor(var1, var3)];
         if(-1 > ~var0) {
            int var6 = Rasterizer.anInterface2_838.method19(111, var0 & '\uffff');
            int var7;
            int var9;
            if(~var6 != -1) {
               if(-1 >= ~var3) {
            ...
            var7 = Rasterizer.anInterface2_838.method10(106, '\uffff' & var0);
            if(~var7 != -1) {
               var7 += 256;
   ...
   private final int method192(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
	...
	static final void addKeyboardHandler(Component component) {
		component.setFocusTraversalKeysEnabled(false);
		component.addKeyListener(Class3_Sub13_Sub3.aClass148_3049);
		component.addFocusListener(Class3_Sub13_Sub3.aClass148_3049);
	}
