...
final class Class3_Sub13_Sub7 extends Class3_Sub13 {
   ...
   static jInterface aClass11_3087 = null;
   static Random tooltipRandomGenerator = new Random();
   private int[] anIntArray3089;
   private int[] anIntArray3091;
   static Frame resizableFrame;
   private int anInt3093 = 2048;
   static boolean aBoolean3094 = false;
   static short[] aShortArray3095 = new short[500];
   private static jString aClass94_3096 = jString.createJString("Close");
   static jString aClass94_3097 = aClass94_3096;
   static js5 aClass153_3098;
   static AbstractSprite aClass3_Sub28_Sub16_3099;
   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         if(~var1 == -1) {
            this.anInt3085 = var2.getUByte();
         } else if(-2 != ~var1) {
            if(-3 == ~var1) {
               this.anInt3086 = var2.getUByte();
            }
         } else {
            this.anInt3093 = var2.getUShort();
         }
         ...
         if(this.aClass114_2382.aBoolean1580) {
            ...
            if(0 == this.anInt3086) {
               ...
               for(int var12 = 0; ~var12 > ~Class113.anInt1559; ++var12) {
                  int var9 = TextureLoader.anIntArray2125[var12];
                  var7 = 0;
