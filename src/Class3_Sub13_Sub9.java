   ...
   final void method157(int var1, Buffer var2, boolean var3) {
      try {
         if(var3) {
            if(~var1 != -1) {
               if(var1 == 1) {
                  this.anInt3113 = var2.getUByte();
               } else if(var1 == 2) {
                  this.anInt3109 = var2.getUShort();
               }
            } else {
               this.anInt3108 = var2.getUByte();
            }
      ...
      try {
         ...
         if(this.aClass114_2382.aBoolean1580) {
            for(int var5 = 0; Class113.anInt1559 > var5; ++var5) {
               int var6 = TextureLoader.anIntArray2125[var5];
