...
final class Class3_Sub14 extends Node {
   ...
   private static final boolean method362(js5 var0) {
      if(!aBoolean2405) {
   ...
   static final Class3_Sub14 method363(js5 var0, int var1, int var2) {
      if(!method362(var0)) {
         var0.method2129(var2, var1);
         return null;
      } else {
