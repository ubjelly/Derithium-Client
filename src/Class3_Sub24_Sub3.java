...
final class Class3_Sub24_Sub3 extends Class3_Sub24 {
   ...
   final Class3_Sub24 method414() {
      try {
         Class3_Sub22 var1;
         do {
            var1 = (Class3_Sub22)this.aClass61_3489.getNext();
            if(null == var1) {
               return null;
            }
   ...
   final Class3_Sub24 method411() {
      try {
         Class3_Sub22 var1 = (Class3_Sub22)this.aClass61_3489.getFirst();
   ...
   static final void method465(int var0, boolean var1) {
      try {
         ...
         Entity.aClass93_2792.method1522(var0);
   ...
   static final InterfaceChangeNode putInterfaceChange(int type, int uid) {
	   InterfaceChangeNode var3 = (InterfaceChangeNode)client.interfaceRecentChanges.get((long)uid | (long)type << 32);
	   if(null == var3) {
		   var3 = new InterfaceChangeNode(type, uid);
		   client.interfaceRecentChanges.put(var3, var3.hash);
	   }

	   return var3;
   }

   static final boolean method467(jString var0, int var1) {
      try {
         if(var0 == null) {
            return false;
         } else {
            for(int var2 = var1; ~AnimationLoader.anInt3591 < ~var2; ++var2) {
               if(var0.method1531(Class3_Sub13_Sub27.aClass94Array3341[var2])) {
                  return true;
               }
            }
   ...
   static final void method468(int var0) {
	   Class88.method1456();
	   Class2.anInterface5Array70 = new Interface5[8];
	   ...
	   Class2.anInterface5Array70[6] = new Class147();
	   Class2.anInterface5Array70[7] = new Class170();
   }
   ...
   final void method415(int var1) {
      try {
         ...
         for(Class3_Sub22 var3 = (Class3_Sub22)this.aClass61_3489.getFirst(); var3 != null; var3 = (Class3_Sub22)this.aClass61_3489.getNext()) {
   ...
   final void method413(int[] var1, int var2, int var3) {
      try {
         ...
         for(Class3_Sub22 var6 = (Class3_Sub22)this.aClass61_3489.getFirst(); var6 != null; var6 = (Class3_Sub22)this.aClass61_3489.getNext()) {
