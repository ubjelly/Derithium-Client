...
final class Class3_Sub26 extends Node {
   ...
   static boolean forceTweeningEnabled = true;
   static int[] anIntArray2559 = new int[]{0, 1, 2, 3, 4, 5, 6, 14};
   static AbstractSprite aClass3_Sub28_Sub16_2560;
   static int anInt2561 = -1;
   static jString aClass94_2562 = jString.createJString("<col=ffffff>");
   ...
   static final void method512(byte var0) {
      try {
         RawObjectCache.aClass93_4043.clearAll();
