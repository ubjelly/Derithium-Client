...
final class Class3_Sub6 extends Node {


   private static jString aClass94_2286 = jString.createJString("wishes to trade with you)3");
   static byte[][] aByteArrayArray2287;
   static int[] anIntArray2288 = new int[32];
   byte[] aByteArray2289;
   static int anInt2291;
   static jString aClass94_2285 = aClass94_2286;
   ...
   static final float[] method119(float[] var0, int var1) {
      try {
         if(var0 != null) {
            ...
            ArrayUtils.arrayCopy(var0, var1, var2, 0, var0.length);
            return var2;
         } else {
            return null;
         }
