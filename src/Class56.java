...
final class Class56 {
   ...
   static jInterface aClass11_886 = null;
   static int[] anIntArray887 = new int[2048];
   static jString aClass94_888 = jString.createJString("<col=ffff00>");
   static DisplayModeInformation[] aClass106Array890;
   
   static jString aClass94_892 = jString.createJString(" )2> <col=ffffff>");
   static int anInt893 = 0;
   private static jString aClass94_894 = jString.createJString("Walk here");
static jString aClass94_891 = aClass94_894;
   ...
   public static void method1187(int var0) {
      try {
         if(var0 != 30351) {
            method1189(-73, -127, -26, 43, 67, 125, 38, 80, (SceneGraphNode)null, -92, true, 27L);
         }
   ...
   static final void method1188(int var0) {
      try {
         MouseHandler.anIntArray1920 = null;
         ...
         if(var0 >= -60) {
            aClass94_891 = (jString)null;
         }

         AbstractTimer.anIntArray1695 = null;
         OverridedInterface.anIntArray2606 = null;
      } catch (RuntimeException var2) {
         throw Class44.method1067(var2, "ib.D(" + var0 + ')');
      }
   }

   static final boolean method1189(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, SceneGraphNode var8, int var9, boolean var10, long var11) {
      boolean var13 = Class44.anIntArrayArrayArray723 == AbstractObjectCache.anIntArrayArrayArray3605;
      int var14 = 0;

      int var16;
      for(int var15 = var1; var15 < var1 + var3; ++var15) {
         for(var16 = var2; var16 < var2 + var4; ++var16) {
            if(var15 < 0 || var16 < 0 || var15 >= jSocket.anInt1234 || var16 >= Class3_Sub13_Sub15.anInt3179) {
               return false;
            }

            GroundTile var17 = Class75_Sub2.groundTiles[var0][var15][var16];
      ...
      for(var16 = var1; var16 < var1 + var3; ++var16) {
         for(var21 = var2; var21 < var2 + var4; ++var21) {
            ...
            for(int var19 = var0; var19 >= 0; --var19) {
               if(Class75_Sub2.groundTiles[var19][var16][var21] == null) {
                  Class75_Sub2.groundTiles[var19][var16][var21] = new GroundTile(var19, var16, var21);
               }
            }

            GroundTile var22 = Class75_Sub2.groundTiles[var0][var16][var21];
