...
final class Class58 {
   ...
   static jString aClass94_910 = jString.createJString("::fpson");
   ...
   static int anInt916;
   static Js5CacheWorker js5CacheWorker;
   ...
   static final Class155 method1195(int var0, Signlink var1, Component var2, int var3, int var4) {
      try {
         if(Class21.anInt443 == 0) {
            ...
            try {
               Class155 var9 = new Class155_Sub2();
               var9.anInt1989 = var0;
               var9.anIntArray1975 = new int[(!jString.aBoolean2150?1:2) * 256];
               ...
               if(Class3_Sub24_Sub4.anInt3507 > 0 && null == Class38_Sub1.aClass15_2613) {
                  ...
                  var1.startThread(Class38_Sub1.aClass15_2613, Class3_Sub24_Sub4.anInt3507);
               }
               ...
               try {
                  ...
                  var5.anIntArray1975 = new int[256 * (jString.aBoolean2150?2:1)];
                  var5.anInt1989 = var0;
   ...
   static final void method1197(js5 var0, byte var1) {
      try {
         if(var1 != 69) {
