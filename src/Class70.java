...
final class Class70 {
   ...
   int anInt1045;
   static jString[] aClass94Array1046 = new jString[200];
   static int anInt1047;
   long aLong1048 = 0L;
   SceneGraphNode aClass140_1049;
   static double aDouble1050 = -1.0D;
   static jString aClass94_1051 = jString.createJString("(Udns");
   SceneGraphNode aClass140_1052;
   static int anInt1053 = 0;
   int anInt1054;
   int anInt1055;
   static Class10 aClass10_1056;
   int anInt1057;
   static js5 aClass153_1058;
   int anInt1059;
   ...
   public static void method1284(byte var0) {
      try {
         if(var0 != -87) {
            aClass94Array1046 = (jString[])null;
         }
   ...
   static final void method1285(js5 var0, boolean var1, int var2, int var3, boolean var4, int var5) {
      try {
   ...
   static final void method1286(int var0, boolean var1, ObjectDefinition var2, int var3, Npc var4, int var5, int var6, Player var7) {
      try {
         ...
         if(null != var2) {
            ...
            Node.aClass61_78.insertBack(var8);
         } else if(null != var4) {
            var8.aClass140_Sub4_Sub2_2324 = var4;
            NpcDefinition var12 = var4.aClass90_3976;
            ...
            jSocket.aClass61_1242.insertBack(var8);
         } else if(null != var7) {
            ...
            RawObjectCache.aClass130_4046.put(var8, var7.username.toLong());
         }
   ...
   static final LDFont method1287(int var0, int var1, js5 var2, js5 var3, int var4) {
      try {
         if(client.spriteExists(var3, var1, var0)) {
            if(var4 != -1) {
               method1284((byte)-124);
            }

            return Class3_Sub13.method163(var2.getFile(var0, var1), 25208);
         } else {
            return null;
         }
