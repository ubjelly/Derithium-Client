               ...
               if(~(1 & var7) != -1) {
                  if(~var6 == 0) {
                     ...
                     if(var12 != null) {
                        if(~var6 == ~var12.anInt1890) {
                           if(var11 != 0) {
                              if(1 == var11) {
                                 ...
                                 var12.anInt1897 = 0;
                                 jSocket.method1470(var2.anInt2829, var10, 183921384, var2.anInt2819, var2 == TextureLoader.selfPlayer, 0);
                              } else if(-3 == ~var11) {
                                 var12.anInt1894 = 0;
                              }
                           } else {
                        ...
                        } else if(var10.anInt1857 >= AnimationDefinition.list(var12.anInt1890, false).anInt1857) {
                           var12 = var2.aClass145Array2809[var9] = null;
                        }
                     }
