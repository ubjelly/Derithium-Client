...
final class Class78 {
   ...
   final void method1372(long var1) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         this.aClass3_Sub30_1113.pos = this.anIntArray1118[var4];
         this.method1377(var4);
         this.anIntArray1115[var4] = this.aClass3_Sub30_1113.pos;
      }

   }

   final boolean method1373() {
      return this.aClass3_Sub30_1113.buf != null;
   }
   ...
   final void method1376(int var1) {
      this.aClass3_Sub30_1113.pos = this.anIntArray1115[var1];
   }
   ...
   private final int method1378(int var1, int var2) {
      int var4;
      if(var2 == 255) {
         int var7 = this.aClass3_Sub30_1113.getUByte();
         var4 = this.aClass3_Sub30_1113.method741();
         if(var7 == 47) {
            this.aClass3_Sub30_1113.pos += var4;
            return 1;
         } else if(var7 == 81) {
            int var5 = this.aClass3_Sub30_1113.getMidInt();
            var4 -= 3;
         ...
         var4 = var2;
         if(var3 >= 1) {
            var4 = var2 | this.aClass3_Sub30_1113.getUByte() << 8;
         }

         if(var3 >= 2) {
            var4 |= this.aClass3_Sub30_1113.getUByte() << 16;
         }
   ...
   private final int method1379(int var1) {
      byte var2 = this.aClass3_Sub30_1113.buf[this.aClass3_Sub30_1113.pos];
      int var5;
      if(var2 < 0) {
         var5 = var2 & 255;
         this.anIntArray1120[var1] = var5;
         ++this.aClass3_Sub30_1113.pos;
      } else {
      ...
      if(var5 != 240 && var5 != 247) {
         ...
         if(var5 == 247 && var3 > 0) {
            int var4 = this.aClass3_Sub30_1113.buf[this.aClass3_Sub30_1113.pos] & 255;
         ...
         this.aClass3_Sub30_1113.pos += var3;
         return 0;
      }
   }

   final void method1380(byte[] var1) {
      this.aClass3_Sub30_1113.buf = var1;
      this.aClass3_Sub30_1113.pos = 10;
      int var2 = this.aClass3_Sub30_1113.getUShort();
      this.anInt1116 = this.aClass3_Sub30_1113.getUShort();
      this.anInt1121 = 500000;
      this.anIntArray1118 = new int[var2];

      int var3;
      int var5;
      for(var3 = 0; var3 < var2; this.aClass3_Sub30_1113.pos += var5) {
         int var4 = this.aClass3_Sub30_1113.getInt();
         var5 = this.aClass3_Sub30_1113.getInt();
         if(var4 == 1297379947) {
            this.anIntArray1118[var3] = this.aClass3_Sub30_1113.pos;
            ++var3;
         }
      }
   ...
   final void method1381(int var1) {
      this.anIntArray1115[var1] = this.aClass3_Sub30_1113.pos;
   }
   ...
   final void method1383() {
      this.aClass3_Sub30_1113.buf = null;
