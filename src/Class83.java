...
final class Class83 {
   ...
   /*static final void method1410(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      try {
         ...
         for(var13 = 0; ~var11 < ~var13; ++var13) {
            ...
            if(var16 > 0) {
               ...
               if(0 <= var17 && ~(AbstractMouseWheel.anIntArrayArrayArray1903.length + -1) <= ~var17) {
                  ...
                  byte[][] var45 = client.aByteArrayArrayArray383[var17];
                  byte[][] var42 = Class3_Sub10.aByteArrayArrayArray2339[var17];
                  byte[][] var23 = Huffman.aByteArrayArrayArray640[var17];
                  byte[][] var43 = InterfaceListener.aByteArrayArrayArray2452[var17];
                  var15 += var5;
                     ...
                     if(~var27 < -1) {
                        ...
                        if(0 <= var28 && var41.length + -1 >= var28 && null != var41[var28]) {
                           ...
                           if(~var28 > -1 || var28 > var41.length + -1) {
                              ...
                              GraphicsLD.fillRect(var14, var25, var16, var27, var32);
                              continue;
                           }
                        }
                        ...
                        if(var33 == 0 && -1 == ~var34) {
                           ...
                           if(0 != var33) {
                              ...
                              if(-1 != ~var36 && ~var16 < -2 && var27 > 1) {
                                 UnderlayType.method2272(GraphicsLD.pixels, var33, var14, var35 & 3, var32, var36 >> 2, var27, var16, var25, true, (byte)21);
                              } else {
                                 GraphicsLD.fillRect(var14, var25, var16, var27, var33);
                              }
                           }
                           ...
                           if(~var34 != -1) {
                              ...
                              if(~var36 == -1 || -2 <= ~var16 || 1 >= var27) {
                                 GraphicsLD.fillRect(var14, var25, var16, var27, var34);
                              }

                              UnderlayType.method2272(GraphicsLD.pixels, var34, var14, var35 & 3, 0, var36 >> 2, var27, var16, var25, var33 == 0, (byte)21);
                           }
                        }
                        ...
                        if(var23[var28] != null) {
                           ...
                           if(-1 != ~var49) {
                              ...
                              if(1 == var49) {
                                 GraphicsLD.drawVerticalLine(var14, var25, var27, var38);
                              } else if(2 == var49) {
                                 GraphicsLD.drawHorizontalLine(var14, var25, var16, var38);
                              } else if(3 != var49) {
                                 if(-5 != ~var49) {
                                    if(var49 != 9) {
                                       if(~var49 != -11) {
                                          if(-12 == ~var49) {
                                             GraphicsLD.drawVerticalLine(var36, var25, var27, 16777215);
                                             GraphicsLD.drawHorizontalLine(var14, var37, var16, var38);
                                          } else if(var49 != 12) {
                                             if(var49 == 17) {
                                                GraphicsLD.drawHorizontalLine(var14, var25, 1, var38);
                                             } else if(var49 != 18) {
                                                if(~var49 == -20) {
                                                   GraphicsLD.drawHorizontalLine(var36, var37, 1, var38);
                                                } else if(~var49 == -21) {
                                                   GraphicsLD.drawHorizontalLine(var14, var37, 1, var38);
                                                } else {
                                                   int var39;
                                                   if(25 == var49) {
                                                      for(var39 = 0; ~var39 > ~var27; ++var39) {
                                                         GraphicsLD.drawHorizontalLine(var39 + var14, -var39 + var37, 1, var38);
                                                      }
                                                   } else if(26 == var49) {
                                                      for(var39 = 0; var39 < var27; ++var39) {
                                                         GraphicsLD.drawHorizontalLine(var39 + var14, var25 + var39, 1, var38);
                                                      }
                                                   }
                                                }
                                             } else {
                                                GraphicsLD.drawHorizontalLine(var36, var25, 1, var38);
                                             }
                                          } else {
                                             GraphicsLD.drawVerticalLine(var14, var25, var27, 16777215);
                                             GraphicsLD.drawHorizontalLine(var14, var37, var16, var38);
                                          }
                                       } else {
                                          GraphicsLD.drawVerticalLine(var36, var25, var27, 16777215);
                                 ...
                                 GraphicsLD.drawVerticalLine(var36, var25, var27, var38);
                              }
                           }
                        }
                     }
                  ...
                  for(int var18 = 0; ~var12 < ~var18; ++var18) {
                     ...
                     var22 = var21 + -var20;
                     GraphicsLD.fillRect(var14, var20, var16, var22, var19);
                  }
         ...
         for(var13 = -2; 2 + var11 > var13; ++var13) {
            ...
            if(~var16 < -1) {
               ...
               var17 = var6 + var13 >> 6;
               var10000 = var15 + var5;
               if(-1 >= ~var17 && Varp.anIntArrayArrayArray558.length + -1 >= var17) {
                  var41 = Varp.anIntArrayArrayArray558[var17];
                     ...
                     if(~var22 < -1) {
                        ...
                        if(~var44 <= -1 && var44 <= -1 + var41.length) {
                           ...
                           if(null != var41[var44]) {
                              ...
                              if(-1 != ~var26) {
                                 var28 = ('\ud228' & var25) >> 14;
                                 Class2 var47 = Class2.list(-1 + var26);
	...
	static final int getDisplayMode() {
		if (Class3_Sub13_Sub10.fullscreenFrame == null) {
			if (HDToolkit.openGLEnabled && Class3_Sub15.aBoolean2427) {
				return 2;
			} else {
				return HDToolkit.openGLEnabled && !Class3_Sub15.aBoolean2427 ? 1 : 0;
			}
		} else {
			return 3;
		}
   ...
   private final Class3_Sub12_Sub1 method1412(int[] var1, int var2, int var3, int var4) {
      try {
         if(var2 != 31947) {
            ...
            var5 |= var3 << 16;
            long var6 = (long)var5;
            Class3_Sub12_Sub1 var8 = (Class3_Sub12_Sub1)this.aClass130_1159.get(var6);
            if(var8 != null) {
               return var8;
               ...
               if(null != var9) {
                  ...
                  this.aClass130_1159.put(var8, var6);
                  if(var1 != null) {
   ...
   final Class3_Sub12_Sub1 method1413(int var1, int var2, int[] var3) {
      try {
         if(1 != this.aClass153_1153.method2121()) {
            if(-2 == ~this.aClass153_1153.getChildCount(var1)) {
               return this.method1412(var3, 31947, var1, 0);
            } else {
               if(var2 < 0) {
                  this.aClass130_1159 = (Hashtable)null;
               }
   ...
   private final Class3_Sub12_Sub1 method1415(int var1, int[] var2, int var3, byte var4) {
      try {
         ...
         if(null != var8) {
            ...
            Class3_Sub14 var9 = (Class3_Sub14)this.aClass130_1155.get(var6);
            if(null == var9) {
               ...
               this.aClass130_1155.put(var9, var6);
            }
   ...
   final Class3_Sub12_Sub1 method1416(int var1, int var2, int[] var3) {
      try {
         if(var1 != 10089) {
            return (Class3_Sub12_Sub1)null;
         } else if(-2 == ~this.aClass153_1157.method2121()) {
            return this.method1415(0, var3, var2, (byte)11);
         } else if(-2 != ~this.aClass153_1157.getChildCount(var2)) {
            throw new RuntimeException();
         } else {
