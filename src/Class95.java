...
final class Class95 {
   ...
   static jString aClass94_1333 = jString.createJString("um");
   static jString aClass94_1335 = jString.createJString("You can(Wt add yourself to your own ignore list)3");;
   static int anInt1336 = 0;
   //static jString aClass94_1337 = jString.createJString("::breakcon");
   static int spriteAmount;
   static AbstractSprite aClass3_Sub28_Sub16_1339;
   static volatile int anInt1340 = -1;
   static jString aClass94_1341 = jString.createJString("logo");
   static jString aClass94_1342 = jString.createJString("details");
      ...
      try {
         ...
         if(~var1 == ~var5) {
            ...
            if(Class101.anInt1425 <= var2 - var5 && var2 + var5 <= Class3_Sub28_Sub18.anInt3765 && -var1 + var3 >= Class159.anInt2020 && ~(var3 - -var1) >= ~Class57.anInt902) {
               ...
               AnimationLoader.method556(var0, var1, var5, (byte)-123, var2, var3);
            }
   ...
   static final int method1585(int var1) {
		--var1;
		var1 |= var1 >>> 1;
		var1 |= var1 >>> 2;
		var1 |= var1 >>> 4;
	...
	static final jString method1586(int var0, int var1) {
		if (var1 > 0 && var1 <= 255) {
			jString var2 = new jString();
			var2.pos = 1;
			var2.buf = new byte[1];
			var2.buf[0] = (byte) var1;
			return var2;
		} else {
