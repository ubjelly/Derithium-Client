...
final class Class97 {
   ...
   static jString aClass94_1363 = jString.createJString("Clientscript error in: ");
   ...
   static js5 aClass153_1372;
   static int[][] anIntArrayArray1373;
   static jString aClass94_1374;
   static int anInt1375;
   static js5Worker aClass153_1376;
   static js5 aClass153_1378;
   boolean aBoolean1379 = false;
   static jString aClass94_1380;
   static LDSprite aClass3_Sub28_Sub16_Sub2_1381;
   ...
   static final void loadTitleScreen(js5 var1) {
	   Class154.anInt1966 = var1.method2120(Class3_Sub28_Sub4.aClass94_3574);
      ...
      try {
         ...
         if(this.anInt1367 != this.anInt1369) {
            if(1 == this.anInt1367) {
               ...
               this.aClass61_1366.insertFront(var4);
   ...
   static {
      ...
      aClass94_1374 = jString.createJString("zap");
      anIntArrayArray1373 = new int[104][104];
      aClass94_1380 = jString.createJString(")4p=");
   }
}
