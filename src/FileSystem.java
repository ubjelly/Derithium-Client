...
final class FileSystem {
         ...
         if(!var6) {
            if(var2 > var4) {
               ...
               for(int var10 = var4; var10 < var2; ++var10) {
                  if(~jString.method1535(var9, Class3_Sub13_Sub16.aClass44_Sub1Array3201[var10], 5730, var0, var1, var3, var5) >= -1) {
   ...
   static final void method1048(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      try {
         ...
         if(-2 >= ~var1 && var4 >= 1 && 102 >= var1 && var4 <= 102) {
            int var8;
            if(!Npc.visibleLevels() && 0 == (2 & Class9.aByteArrayArrayArray113[0][var1][var4])) {
               var8 = var2;
            ...
            Class20.method910(-96, var4, var1, var2, var7, var8, Class86.collisionMap[var2]);
            if(0 <= var0) {
               boolean var9 = KeyboardHandler.showGroundDecorations;
               KeyboardHandler.showGroundDecorations = true;
               Class110.method1683(var8, false, var2, false, Class86.collisionMap[var2], var0, var6, var1, var4, var3);
               KeyboardHandler.showGroundDecorations = var9;
            }
         }
   ...
   final byte[] get(int var1) {
         ...
         synchronized(var3) {
            Object var10000;
            try {
               if(~this.aClass30_683.method976() > ~((long)(var1 * 6 + 6))) {
                  var10000 = null;
               ...
               if(0 < var5 && ~((long)var5) >= ~(this.aClass30_681.method976() / 520L)) {
                  ...
                  for(int var9 = 0; ~var8 > ~var4; var5 = var13) {
                     ...
                     if(var13 < 0 || (long)var13 > this.aClass30_681.method976() / 520L) {
                        var10000 = null;
                        return (byte[])var10000;
                     }
   ...
   static final jString longToString(long var1) {
	   if(-1L > ~var1 && -6582952005840035282L < ~var1) {
           if(-1L == ~(var1 % 37L)) {
              ...
              jString var10 = new jString();
              var10.buf = var6;
              var10.pos = var6.length;
              return var10;
           }
        } else {
           return null;
   ...
   static final void method1053(byte var0, js5 var1) {
      try {
   ...
   FileSystem(int var1, Class30 var2, Class30 var3, int var4) {
      try {
         this.anInt687 = var4;
      ...
      try {
         ...
         synchronized(var6) {
            try {
               ...
               boolean var10000;
               if(var5) {
                  if(this.aClass30_683.method976() < (long)(6 + var3 * 6)) {
                     var10000 = false;
                     return var10000;
                  }
                  ...
                  if(~var7 >= -1 || ~(this.aClass30_681.method976() / 520L) > ~((long)var7)) {
                     var10000 = false;
                     return var10000;
                  }
               } else {
                  var7 = (int)((this.aClass30_681.method976() - -519L) / 520L);
                  if(-1 == ~var7) {
                     var7 = 1;
                  }
               }
                  ...
                  if(~var8 > ~var2) {
                     label146: {
                        ...
                        if(var5) {
                           ...
                           if(var10 < 0 || ~((long)var10) < ~(this.aClass30_681.method976() / 520L)) {
                              var10000 = false;
                              return var10000;
                           }
                        }
                        ...
                        if(~var10 == -1) {
                           var5 = false;
                           var10 = (int)((this.aClass30_681.method976() - -519L) / 520L);
                           if(~var10 == -1) {
                              ++var10;
                           }
