...
abstract class Font extends NodeSub {

   int[] anIntArray3709;
   private int anInt3710;
   private static jString aClass94_3711 = jString.createJString("gt");
   private static jString aClass94_3712 = jString.createJString("lt");
   private static jString aClass94_3713 = jString.createJString("shad=");
   private static jString aClass94_3714 = jString.createJString("shy");
   private static jString aClass94_3715 = jString.createJString("trans=");
   private static jString aClass94_3716 = jString.createJString("u=");
   private static jString aClass94_3717 = jString.createJString("str=");
   private static jString aClass94_3718 = jString.createJString("euro");
   private int[] anIntArray3719;
   private static jString aClass94_3720 = jString.createJString(")4col");
   int[] anIntArray3721;
   private int anInt3722;
   private int[] anIntArray3723;
   private static jString aClass94_3724 = jString.createJString(")4shad");
   private static jString aClass94_3725 = jString.createJString("col=");
   private static jString aClass94_3726 = jString.createJString("<gt>");
   int anInt3727 = 0;
   private static jString aClass94_3728 = jString.createJString("u");
   private static jString aClass94_3729 = jString.createJString("times");
   private int[] anIntArray3730;
   private static jString aClass94_3731 = jString.createJString(")4trans");
   private static jString aClass94_3732 = jString.createJString("nbsp");
   private byte[] aByteArray3733;
   private static jString aClass94_3734 = jString.createJString("<lt>");
   private static jString aClass94_3735 = jString.createJString(")4u");
   private int[] anIntArray3736;
   private static jString aClass94_3737 = jString.createJString("br");
   private static jString aClass94_3738 = jString.createJString("shad");
   private static jString aClass94_3739 = jString.createJString("img=");
   private AbstractIndexedSprite[] aClass109Array3740;
   private static jString aClass94_3741 = jString.createJString("copy");
   private static jString aClass94_3742 = jString.createJString(")4str");
   private static jString aClass94_3743 = jString.createJString("reg");
   private static jString aClass94_3744 = jString.createJString("str");
   private static jString aClass94_3745 = Class47.createBlankJString(100);
   ...
   private static jString[] aClass94Array3753 = new jString[100];
   private static int anInt3754 = -1;
   private static int anInt3755 = 0;
   private static int anInt3756 = 0;


   final int method676(jString var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      return this.method693(var1, var2, var3, var4, var5, var6, var7, 256, var8, var9, var10);
   }

   private final void method677(jString var1, int var2, int var3) {
      var3 -= this.anInt3727;
      int var4 = -1;
      int var5 = 0;
      ...
      for(int var7 = 0; var7 < var6; ++var7) {
         ...
         if(var8 == 60) {
            ...
            int var10;
            if(var8 == 62 && var4 != -1) {
               jString var9 = var1.substring(var7, var4 + 1);
               var4 = -1;
               if(var9.equals(aClass94_3712)) {
                  var8 = 60;
               } else if(var9.equals(aClass94_3711)) {
                  var8 = 62;
               } else if(var9.equals(aClass94_3732)) {
                  var8 = 160;
               } else if(var9.equals(aClass94_3714)) {
                  var8 = 173;
               } else if(var9.equals(aClass94_3729)) {
                  var8 = 215;
               } else if(var9.equals(aClass94_3718)) {
                  var8 = 128;
               } else if(var9.equals(aClass94_3741)) {
                  var8 = 169;
               } else {
                  if(!var9.equals(aClass94_3743)) {
                     if(var9.method1558(aClass94_3739, 0)) {
                        try {
                           ...
                           int var12 = this.anIntArray3723 != null?this.anIntArray3723[var10]:var15.trimHeight;
                           if(anInt3750 == 256) {
            ...
            if(var4 == -1) {
               ...
               if(anInt3746 != -1) {
                  if(HDToolkit.openGLEnabled) {
                     GraphicsHD.drawHorizontalLine(var2, var3 + (int)((double)this.anInt3727 * 0.7D), var11, anInt3746);
                  } else {
                     GraphicsLD.drawHorizontalLine(var2, var3 + (int)((double)this.anInt3727 * 0.7D), var11, anInt3746);
                  }
               ...
               if(anInt3747 != -1) {
                  if(HDToolkit.openGLEnabled) {
                     GraphicsHD.drawHorizontalLine(var2, var3 + this.anInt3727 + 1, var11, anInt3747);
                  } else {
                     GraphicsLD.drawHorizontalLine(var2, var3 + this.anInt3727 + 1, var11, anInt3747);
                  }
               }
   ...
   final int method680(jString var1, int var2) {
   ...
   final void method681(jString var1, int var2, int var3, int var4, int var5) {
      if(var1 != null) {
	...
	final int method682(jString var1) {
		if (var1 == null) {
			return 0;
		} else {
			int var2 = -1;
			...
			for (int var6 = 0; var6 < var5; ++var6) {
				...
				if (var7 == 60) {
					...
					if (var7 == 62 && var2 != -1) {
						jString var8 = var1.substring(var6, var2 + 1);
						var2 = -1;
						if (var8.equals(aClass94_3712)) {
							var7 = 60;
						} else if (var8.equals(aClass94_3711)) {
							var7 = 62;
						} else if (var8.equals(aClass94_3732)) {
							var7 = 160;
						} else if (var8.equals(aClass94_3714)) {
							var7 = 173;
						} else if (var8.equals(aClass94_3729)) {
							var7 = 215;
						} else if (var8.equals(aClass94_3718)) {
							var7 = 128;
						} else if (var8.equals(aClass94_3741)) {
							var7 = 169;
						} else {
							if (!var8.equals(aClass94_3743)) {
								if (var8.method1558(aClass94_3739, 0)) {
									try {
										int var9 = var8.method1556(4, (byte) -74).method1552((byte) -101);
										var4 += this.aClass109Array3740[var9].trimWidth;
										var3 = 0;
   ...
   final int method683(jString var1, int var2, int var3, int var4, int var5, Random var6, int var7) {
      if(var1 == null) {
         return 0;
      } else {
   ...
   static final jString method686(jString var0) {
      ...
      jString var6 = Class47.createBlankJString(var1 + var2);
   ...
   final void method688(jString var1, int var2, int var3, int var4, int var5) {
      if(var1 != null) {
         this.method698(var4, var5);
   ...
   private final void method690(jString var1, int var2) {
      int var3 = 0;
      boolean var4 = false;
      int var5 = var1.getLength();
   ...
   final int method691(jString var1, int[] var2, jString[] var3) {
      if(var1 == null) {
         return 0;
      } else {
         ...
         for(int var13 = 0; var13 < var12; ++var13) {
            ...
            if(var14 == 60) {
               ...
               if(var14 == 62 && var9 != -1) {
                  jString var15 = var1.substring(var13, var9 + 1);
                  var9 = -1;
                  aClass94_3745.method1572(60, (byte)111);
                  aClass94_3745.method1533(var15, true);
                  aClass94_3745.method1572(62, (byte)112);
                  if(var15.equals(aClass94_3737)) {
                     if(var3[var11] != null) {
                        var3[var11].method1553(0, false);
                        var3[var11].method1542(aClass94_3745, var5, aClass94_3745.getLength());
                     } else {
                        var3[var11] = aClass94_3745.method1563().substring(aClass94_3745.getLength(), var5);
                     }
                     ...
                     var6 = -1;
                     var10 = 0;
                  } else if(var15.equals(aClass94_3712)) {
                     ...
                     var10 = 60;
                  } else if(var15.equals(aClass94_3711)) {
                     ...
                     var10 = 62;
                  } else if(var15.equals(aClass94_3732)) {
                     ...
                     var10 = 160;
                  } else if(var15.equals(aClass94_3714)) {
                     ...
                     var10 = 173;
                  } else if(var15.equals(aClass94_3729)) {
                     ...
                     var10 = 215;
                  } else if(var15.equals(aClass94_3718)) {
                     ...
                     var10 = 128;
                  } else if(var15.equals(aClass94_3741)) {
                     ...
                     var10 = 169;
                  } else if(var15.equals(aClass94_3743)) {
                     ...
                     try {
                        ...
                        var4 += this.aClass109Array3740[var16].trimWidth;
                        var10 = 0;
               ...
               if(var9 == -1) {
                  ...
                  if(var2 != null && var4 > var2[var11 < var2.length?var11:var2.length - 1] && var6 >= 0) {
                     if(var3[var11] != null) {
                        ...
                        var3[var11] = aClass94_3745.method1563().substring(var6 - var8, var5);
                     }
         ...
         if(aClass94_3745.getLength() > var5) {
            if(var3[var11] != null) {
               var3[var11].method1553(0, false);
               var3[var11] = var3[var11].method1542(aClass94_3745, var5, aClass94_3745.getLength());
            } else {
               var3[var11] = aClass94_3745.method1563().substring(aClass94_3745.getLength(), var5);
            }
   ...
   final void method692(jString var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      if(var1 != null) {
         this.method698(var4, var5);
   ...
   final int method693(jString var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      if(var1 == null) {
         return 0;
      } else {
   ...
   final void method695(jString var1, int var2, int var3, int var4, int var5, int var6) {
      if(var1 != null) {
         this.method698(var4, var5);
   ...
   final void method696(jString var1, int var2, int var3, int var4, int var5, int var6) {
      if(var1 != null) {
         this.method698(var4, var5);
         int var7 = var1.getLength();
         int[] var8 = new int[var7];
   ...
   final void method699(jString var1, int var2, int var3, int var4, int var5) {
      if(var1 != null) {
         this.method698(var4, var5);
   ...
   final int method702(jString var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, Random var10, int var11, int[] var12) {
      if(var1 == null) {
         return 0;
      } else {
   ...
   private final void method703(jString var1, int var2, int var3, int[] var4, int[] var5) {
      var3 -= this.anInt3727;
      int var6 = -1;
      int var7 = 0;
      int var8 = 0;
      ...
      for(int var10 = 0; var10 < var9; ++var10) {
         ...
         if(var11 == 60) {
            ...
            int var15;
            if(var11 == 62 && var6 != -1) {
               jString var12 = var1.substring(var10, var6 + 1);
               var6 = -1;
               if(var12.equals(aClass94_3712)) {
                  var11 = 60;
               } else if(var12.equals(aClass94_3711)) {
                  var11 = 62;
               } else if(var12.equals(aClass94_3732)) {
                  var11 = 160;
               } else if(var12.equals(aClass94_3714)) {
                  var11 = 173;
               } else if(var12.equals(aClass94_3729)) {
                  var11 = 215;
               } else if(var12.equals(aClass94_3718)) {
                  var11 = 128;
               } else if(var12.equals(aClass94_3741)) {
                  var11 = 169;
               } else {
                  if(!var12.equals(aClass94_3743)) {
                     if(var12.method1558(aClass94_3739, 0)) {
                        try {
                           ...
                           int var17 = this.anIntArray3723 != null?this.anIntArray3723[var15]:var20.trimHeight;
                           if(anInt3750 == 256) {
            ...
            if(var6 == -1) {
               ...
               if(anInt3746 != -1) {
                  if(HDToolkit.openGLEnabled) {
                     GraphicsHD.drawHorizontalLine(var2, var3 + (int)((double)this.anInt3727 * 0.7D), var16, anInt3746);
                  } else {
                     GraphicsLD.drawHorizontalLine(var2, var3 + (int)((double)this.anInt3727 * 0.7D), var16, anInt3746);
                  }
               }

               if(anInt3747 != -1) {
                  if(HDToolkit.openGLEnabled) {
                     GraphicsHD.drawHorizontalLine(var2, var3 + this.anInt3727, var16, anInt3747);
                  } else {
                     GraphicsLD.drawHorizontalLine(var2, var3 + this.anInt3727, var16, anInt3747);
                  }
               }
