...
final class GrandExchangeItem {
   ...
   static jString aClass94_1745 = jString.createJString("settings");
   int anInt1746;
   int anInt1747;
   static int spriteTrimHeight;
   static jInterface aClass11_1749;
   int anInt1750;
   static js5 aClass153_1751;
   int anInt1752;
   ...
   static final void method1803(byte var0) {
      try {
         if(var0 >= 4) {
            Class82.aClass93_1146.clearSoftReference();
            Class159.aClass93_2016.clearSoftReference();
         }
      } catch (RuntimeException var2) {
   ...
   GrandExchangeItem(Buffer var1) {
      try {
         this.aByte1742 = var1.getByte();
         this.anInt1752 = var1.getUShort();
