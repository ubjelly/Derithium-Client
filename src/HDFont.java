...
final class HDFont extends Font {
   ...
   final void method678(int var1, int var2, int var3, int var4, int var5, int var6, boolean var7) {
      GL var8;
      if(GraphicsHD.aClass3_Sub28_Sub16_Sub1_447 != null) {
         HDToolkit.initFontStuff();
         var8 = HDToolkit.gl;
         var8.glColor3ub((byte)(var6 >> 16), (byte)(var6 >> 8), (byte)var6);
         var8.glTranslatef((float)var2, (float)(HDToolkit.canvasHeight - var3), 0.0F);
         ...
         HDToolkit.bindTexture(this.anInt4084);
         HDSprite var13 = GraphicsHD.aClass3_Sub28_Sub16_Sub1_447;
         var8.glActiveTexture('\u84c1');
         var8.glEnable(3553);
         var8.glBindTexture(3553, var13.textureId);
         var8.glTexEnvi(8960, '\u8571', 7681);
         var8.glTexEnvi(8960, '\u8580', '\u8578');
         float var14 = (float)(var2 - GraphicsHD.startX) / (float)var13.anInt4075;
         float var15 = (float)(var3 - GraphicsHD.startY) / (float)var13.anInt4079;
         float var16 = (float)(var2 + var4 - GraphicsHD.startX) / (float)var13.anInt4075;
         float var17 = (float)(var3 + var5 - GraphicsHD.startY) / (float)var13.anInt4079;
         var8.glBegin(6);
   ...
   final void method679(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8) {
      ...
      var9.glTranslatef((float)var2, (float)(HDToolkit.canvasHeight - var3), 0.0F);
   ...
   HDFont(byte[] var1, int[] var2, int[] var3, int[] var4, int[] var5, byte[][] var6) {
   ...
   private final void method708(byte[][] var1) {
      if(this.anInt4084 == -1) {
         ...
         this.anInt4087 *= 16;
         this.anInt4087 = Class95.method1585(this.anInt4087);
