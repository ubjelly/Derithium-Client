...
class HDSprite extends AbstractSprite {
   ...
   final void method645(int var1, int var2, HDSprite var3) {
      if(var3 != null) {
         HDToolkit.initSpriteStuff();
         HDToolkit.bindTexture(var3.textureId);
         var3.method644(1);
         ...
         float var5 = (float)(var1 - GraphicsHD.startX) / (float)var3.anInt4075;
         float var6 = (float)(var2 - GraphicsHD.startY) / (float)var3.anInt4079;
         float var7 = (float)(var1 + this.width - GraphicsHD.startX) / (float)var3.anInt4075;
         float var8 = (float)(var2 + this.height - GraphicsHD.startY) / (float)var3.anInt4079;
         var1 += this.offsetX;
         var2 += this.offsetY;
         var4.glBegin(6);
         ...
         var4.glVertex2f((float)(var1 + this.width), (float)(HDToolkit.canvasHeight - var2));
         var4.glMultiTexCoord2f('\u84c1', var5, var6);
         var4.glTexCoord2f(0.0F, 0.0F);
         var4.glVertex2f((float)var1, (float)(HDToolkit.canvasHeight - var2));
         var4.glMultiTexCoord2f('\u84c1', var5, var8);
         var4.glTexCoord2f(0.0F, var10);
         var4.glVertex2f((float)var1, (float)(HDToolkit.canvasHeight - (var2 + this.height)));
         var4.glMultiTexCoord2f('\u84c1', var7, var8);
         var4.glTexCoord2f(var9, var10);
         var4.glVertex2f((float)(var1 + this.width), (float)(HDToolkit.canvasHeight - (var2 + this.height)));
         var4.glEnd();
   ...
   final void method646(int var1, int var2, int var3, int var4, int var5) {
      ...
      var7 *= (float)var4;
      var8 *= (float)var5;
      int var9 = var1 + this.offsetX;
      int var10 = var9 + this.width * var4;
      int var11 = HDToolkit.canvasHeight - var2 - this.offsetY;
   ...
   final void method647(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
	  // System.out.println(var9.width+":"+var9.height+":"+var9.anInt4075+":"+var9.anInt4079);
     // if(var9 != null) {
         HDToolkit.initSpriteStuff();
         //HDToolkit.bindTexture(var9.textureId);
         //var9.method644(1);
         GL gl = HDToolkit.gl;//var10
         HDToolkit.bindTexture(this.textureId);
         this.method644(1);
         /*var10.glActiveTexture('\u84c1');
         var10.glEnable(3553);
         var10.glBindTexture(3553, var9.textureId);
         ...
         float var25 = (float)172 / (float)256;
         float var26 = (float)156 / (float)256;
         gl.glBegin(6);
         gl.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         float var27 = 65536.0F * (float)this.anInt4075;
         float var28 = (float)(65536 * this.anInt4079);
         gl.glMultiTexCoord2f('\u84c1', var25, 0.0F);
         gl.glTexCoord2f((float)var19 / var27, (float)var20 / var28);
         gl.glVertex2f((float)(var1 + var3), (float)(HDToolkit.canvasHeight - var2));
         gl.glMultiTexCoord2f('\u84c1', 0.0F, 0.0F);
         gl.glTexCoord2f((float)var17 / var27, (float)var18 / var28);
         gl.glVertex2f((float)var1, (float)(HDToolkit.canvasHeight - var2));
         gl.glMultiTexCoord2f('\u84c1', 0.0F, var26);
         gl.glTexCoord2f((float)var21 / var27, (float)var22 / var28);
         gl.glVertex2f((float)var1, (float)(HDToolkit.canvasHeight - (var2 + var4)));
         gl.glMultiTexCoord2f('\u84c1', var25, var26);
         gl.glTexCoord2f((float)var23 / var27, (float)var24 / var28);
         gl.glVertex2f((float)(var1 + var3), (float)(HDToolkit.canvasHeight - (var2 + var4)));
         gl.glEnd();
         gl.glTexEnvi(8960, '\u8571', 8448);
         gl.glTexEnvi(8960, '\u8580', 5890);
         //gl.glDisable(3553);
   ...
   final void method648(int var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      var1 -= this.offsetX << 4;
      var2 -= this.offsetY << 4;
      var7.glTranslatef((float)var3 / 16.0F, (float)HDToolkit.canvasHeight - (float)var4 / 16.0F, 0.0F);
   ...
   final void method639(int var1, int var2, int var3, int var4) {
      if(var3 > 0 && var4 > 0) {
         ...
         float var16 = (float)(HDToolkit.canvasHeight - var2);
   ...
   public final void finalize() throws Throwable {
      if(this.textureId != -1) {
         Class31.method991(this.textureId, this.anInt4074, this.anInt4080);
         this.textureId = -1;
         this.anInt4074 = 0;
      }
   ...
   final void method642(int var1, int var2, int var3, int var4, int var5) {
      if(var3 > 0 && var4 > 0) {
         ...
         float var17 = (float)(HDToolkit.canvasHeight - var2);
   ...
   final void method649(int var1, int var2, int var3, int var4) {
      ...
      int var10 = HDToolkit.canvasHeight - var2 - this.offsetY;
   ...
   void convert(int[] var1) {
      ...
      if(this.textureId == -1) {
         ...
         var10.glGenTextures(1, textures, 0);
   ...
   HDSprite(LDSprite var1) {
      this.trimWidth = var1.trimWidth;
      this.trimHeight = var1.trimHeight;
      this.offsetX = var1.offsetX;
      this.offsetY = var1.offsetY;
      this.width = var1.width;
      this.height = var1.height;
      this.convert(var1.pixels);
      this.generateList();
   }
}
