...
final class Huffman {
   ...
   static AbstractSprite aClass3_Sub28_Sub16_637;
   static int anInt638;
   static int anInt639;
   static byte[][][] aByteaArrayArrayArray640;
   static int anInt641;


   static final AbstractTimer method1012() {
	   try {
   ...
   static final jString method1013(byte var0, int var1) {
      try {
         jString var2 = Class72.method1298(var1);
         if(var0 >= -87) {
            return (jString)null;
         } else {
            for(int var3 = var2.getLength() + -3; var3 > 0; var3 -= 3) {
               var2 = client.method903(new jString[]{var2.substring(var3, 0), Class3_Sub13_Sub22.aClass94_3268, var2.method1556(var3, (byte)-74)});
            }

            return var2.getLength() > 9?client.method903(new jString[]{KeyboardHandler.aClass94_1917, var2.substring(-8 + var2.getLength(), 0), Class3_Sub13_Sub10.aClass94_3124, Class72.aClass94_1072, var2, Js5CacheWorker.aClass94_995}):(6 < var2.getLength()?client.method903(new jString[]{Class3_Sub13_Sub17.aClass94_3211, var2.substring(-4 + var2.getLength(), 0), AnimationLoader.aClass94_3586, Class72.aClass94_1072, var2, Js5CacheWorker.aClass94_995}):client.method903(new jString[]{Class167.aClass94_2082, var2, StringNode.aClass94_2584}));
         }
   ...
   /*static final void method1014() {
         for(int var4 = 0; var4 < SubScript.anInt869; ++var4) {
            UnderlayType var5 = UnderlayType.list(var4);
            if(null != var5) {
               int var6 = var5.anInt2095;
               if(0 <= var6 && !Rasterizer.anInterface2_838.method17(var6)) {
                  var6 = -1;
               }
               ...
               if(-1 < ~var5.anInt2098) {
                  if(var6 >= 0) {
                     var7 = Rasterizer.anIntArray834[StringNode.method729(Rasterizer.anInterface2_838.method15(var6), 96)];
                     ...
                     var10 = var9 + (896 & var8) + ('\ufc00' & var8);
                     var7 = Rasterizer.anIntArray834[StringNode.method729(var10, 96)];
                  }
               } else {
                  var8 = var5.anInt2098;
                  var9 = (127 & var8);
