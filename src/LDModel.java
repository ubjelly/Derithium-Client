...
final class LDModel extends AbstractModel {
   ...
   private static LDModel aClass140_Sub1_Sub2_3902 = new LDModel();
   private byte[] aByteArray3903;
   private static int[] anIntArray3904 = new int[1];
   private static int[] anIntArray3905 = new int[1];
   private static LDModel aClass140_Sub1_Sub2_3906 = new LDModel();
   ...
   private static LDModel aClass140_Sub1_Sub2_3915 = new LDModel();
   ...
   private final void method1934(int var1) {
      if(aBooleanArray3917[var1]) {
         ...
         Rasterizer.aBoolean849 = aBooleanArray3937[var1];
         if(this.aByteArray3903 == null) {
            Rasterizer.alpha = 0;
         } else {
            Rasterizer.alpha = this.aByteArray3903[var1] & 255;
         }
         ...
         if(this.aShortArray3908 != null && this.aShortArray3908[var1] != -1) {
            ...
            Rasterizer.method1144(anIntArray3932[var2], anIntArray3932[var3], anIntArray3932[var4], anIntArray3943[var2], anIntArray3943[var3], anIntArray3943[var4], Rasterizer.anIntArray834[this.anIntArray3898[var1] & '\uffff']);
         } else {
            Rasterizer.method1154(anIntArray3932[var2], anIntArray3932[var3], anIntArray3932[var4], anIntArray3943[var2], anIntArray3943[var3], anIntArray3943[var4], this.anIntArray3898[var1] & '\uffff', this.anIntArray3874[var1] & '\uffff', this.anIntArray3896[var1] & '\uffff');
         }
      ...
      for(int var4 = 0; var4 < this.anInt3889; ++var4) {
         ...
         if(var3 == -1) {
            ...
            if(this.anIntArray3896[var4] == -1) {
               ...
               this.anIntArray3898[var4] = var2 | blendColor(var1, var2 >> 17);
            } else if(this.anIntArray3896[var4] != -2) {
               var2 = this.anIntArray3898[var4] & -131072;
               this.anIntArray3898[var4] = var2 | blendColor(var1, var2 >> 17);
               var2 = this.anIntArray3874[var4] & -131072;
               this.anIntArray3874[var4] = var2 | blendColor(var1, var2 >> 17);
               var2 = this.anIntArray3896[var4] & -131072;
               this.anIntArray3896[var4] = var2 | blendColor(var1, var2 >> 17);
            }
         }
      }
   ...
   private final AbstractModel method1939(boolean var1, boolean var2, LDModel var3, byte[] var4, short[] var5, int[] var6, int[] var7, int[] var8) {
   ...
   static final int blendColor(int color, int modifier) {
      modifier = modifier * (color & 127) >> 7;
      if(modifier < 2) {
         modifier = 2;
      } else if(modifier > 126) {
         modifier = 126;
      }

      return (color & '\uff80') + modifier;
   }
               ...
               if(var19 / var13 < Class145.anInt1898) {
                  ...
                  if(var21 / var13 > Class1.anInt55) {
                     ...
                     if(var22 / var13 < Class86.anInt1195) {
                        ...
                        int var26 = Rasterizer.anInt846;
                        int var27 = Rasterizer.anInt835;
                        int var28 = 0;
                        int var29 = 0;
                        if(var1 != 0) {
                           var28 = Rasterizer.sineTable[var1];
                           var29 = Rasterizer.cosineTable[var1];
                        }
                        ...
                        if(var9 > 0L && Class3_Sub13_Sub7.aBoolean3094 && var14 > 0) {
                           ...
                           if(Class3_Sub28_Sub11.anInt3642 >= var31 && Class3_Sub28_Sub11.anInt3642 <= var33 && client.anInt384 >= var32 && client.anInt384 <= var34) {
                              var31 = 999999;
                              var33 = -999999;
                              var32 = 999999;
                              var34 = -999999;
   ...
   final LDModel method1941(int var1, int var2, int[][] var3, int[][] var4, int var5, int var6, int var7, boolean var8) {
      if(!this.aBoolean3897) {
         this.method1947();
      }
      ...
      if((var1 == 1 || var1 == 2 || var1 == 3 || var1 == 5) && (var9 < 0 || var10 + 128 >> 7 >= var3.length || var11 < 0 || var12 + 128 >> 7 >= var3[0].length)) {
         ...
         if(var8) {
            ...
            if(var1 == 3) {
               var13.anIntArray3885 = Class65.arrayCopy(this.anIntArray3885);
               var13.anIntArray3883 = Class65.arrayCopy(this.anIntArray3883);
               var13.anIntArray3895 = Class65.arrayCopy(this.anIntArray3895);
            } else {
   ...
   final void method1893(int var1, int var2, int var3, int var4, int var5, int var6, int var7, long var8) {
      try {
         ...
         int var10 = Rasterizer.anInt846;
         int var11 = Rasterizer.anInt835;
         int var12 = Rasterizer.sineTable[var1];
         int var13 = Rasterizer.cosineTable[var1];
         int var14 = Rasterizer.sineTable[var2];
         int var15 = Rasterizer.cosineTable[var2];
         int var16 = Rasterizer.sineTable[var3];
         int var17 = Rasterizer.cosineTable[var3];
         int var18 = Rasterizer.sineTable[var4];
         int var19 = Rasterizer.cosineTable[var4];
         ...
         this.method1945(false, var8 >= 0L, var8, this.aShort3886, this.aShort3886 << 1, (ParticleEngine)null);
   ...
   private final void method1942(int var1) {
      int var2 = Rasterizer.anInt846;
      int var3 = Rasterizer.anInt835;
      int var4 = 0;
      ...
      int var20;
      if(var4 == 3) {
         if(var11 < 0 || var12 < 0 || var13 < 0 || var11 > Rasterizer.anInt847 || var12 > Rasterizer.anInt847 || var13 > Rasterizer.anInt847) {
         ...
         if(this.aShortArray3908 != null && this.aShortArray3908[var1] != -1) {
            ...
            Rasterizer.method1144(var14, var15, var16, var11, var12, var13, Rasterizer.anIntArray834[this.anIntArray3898[var1] & '\uffff']);
         } else {
            Rasterizer.method1154(var14, var15, var16, var11, var12, var13, anIntArray3936[0], anIntArray3936[1], anIntArray3936[2]);
         }
      }

      if(var4 == 4) {
         if(var11 < 0 || var12 < 0 || var13 < 0 || var11 > Rasterizer.anInt847 || var12 > Rasterizer.anInt847 || var13 > Rasterizer.anInt847 || anIntArray3919[3] < 0 || anIntArray3919[3] > Rasterizer.anInt847) {
            Rasterizer.aBoolean849 = true;
         }
         ...
         if(this.aShortArray3908 != null && this.aShortArray3908[var1] != -1) {
            ...
            if(this.anIntArray3896[var1] == -1) {
               ...
               Rasterizer.method1138(var14, var16, anIntArray3925[3], var11, var13, anIntArray3919[3], this.anIntArray3898[var1], this.anIntArray3898[var1], this.anIntArray3898[var1], anIntArray3948[var17], anIntArray3948[var18], anIntArray3948[var19], anIntArray3928[var17], anIntArray3928[var18], anIntArray3928[var19], anIntArray3921[var17], anIntArray3921[var18], anIntArray3921[var19], var21);
            } else {
               Rasterizer.method1138(var14, var15, var16, var11, var12, var13, anIntArray3936[0], anIntArray3936[1], anIntArray3936[2], anIntArray3948[var17], anIntArray3948[var18], anIntArray3948[var19], anIntArray3928[var17], anIntArray3928[var18], anIntArray3928[var19], anIntArray3921[var17], anIntArray3921[var18], anIntArray3921[var19], var21);
            ...
            var17 = Rasterizer.anIntArray834[this.anIntArray3898[var1] & '\uffff'];
            Rasterizer.method1144(var14, var15, var16, var11, var12, var13, var17);
            Rasterizer.method1144(var14, var16, anIntArray3925[3], var11, var13, anIntArray3919[3], var17);
         } else {
            Rasterizer.method1154(var14, var15, var16, var11, var12, var13, anIntArray3936[0], anIntArray3936[1], anIntArray3936[2]);
            Rasterizer.method1154(var14, var16, anIntArray3925[3], var11, var13, anIntArray3919[3], anIntArray3936[0], anIntArray3936[2], anIntArray3936[3]);
         }
      }
   ...
   final AbstractModel method1943(AbstractModel var1) {
      return new LDModel(new LDModel[]{this, (LDModel)var1}, 2);
   }
   ...
   private final void method1945(boolean var1, boolean var2, long var3, int var5, int var6, ParticleEngine var7) {
      if(var6 < 1600) {
         int var8 = 0;
         int var9 = 0;
         int var10;
         ...
         for(var10 = 0; var10 < this.anInt3889; ++var10) {
            if(this.anIntArray3896[var10] != -2) {
               ...
               if(var1 && (var14 == -5000 || var15 == -5000 || var16 == -5000)) {
                  ...
                  if(var2 && this.method1944(Class3_Sub28_Sub11.anInt3642 + Rasterizer.anInt846, client.anInt384 + Rasterizer.anInt835, anIntArray3932[var11], anIntArray3932[var12], anIntArray3932[var13], var14, var15, var16)) {
                  ...
                  if((var14 - var15) * (anIntArray3932[var13] - anIntArray3932[var12]) - (anIntArray3932[var11] - anIntArray3932[var12]) * (var16 - var15) > 0) {
                     ...
                     if(var14 >= 0 && var15 >= 0 && var16 >= 0 && var14 <= Rasterizer.anInt847 && var15 <= Rasterizer.anInt847 && var16 <= Rasterizer.anInt847) {
   ...
   final void method1946(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      try {
         ...
         int var9 = Rasterizer.anInt846;
         int var10 = Rasterizer.anInt835;
         int var11 = Rasterizer.sineTable[var1];
         int var12 = Rasterizer.cosineTable[var1];
         int var13 = Rasterizer.sineTable[var2];
         int var14 = Rasterizer.cosineTable[var2];
         int var15 = Rasterizer.sineTable[var3];
         int var16 = Rasterizer.cosineTable[var3];
         int var17 = Rasterizer.sineTable[var4];
         int var18 = Rasterizer.cosineTable[var4];
         ...
         this.method1945(false, false, 0L, this.aShort3886, this.aShort3886 << 1, (ParticleEngine)null);
   ...
   LDModel(ModelBuilder var1, int var2, int var3, int var4, int var5, int var6) {
      var1.calculateNormals();
      var1.method2012();
      this.anInt3891 = var1.vertexCount;
      this.anIntArray3885 = var1.xVertices;
      this.anIntArray3883 = var1.yVertices;
      this.anIntArray3895 = var1.zVertices;
      this.anInt3889 = var1.triangleCount;
      this.anIntArray3901 = var1.trianglesA;
      this.anIntArray3876 = var1.trianglesB;
      this.anIntArray3887 = var1.trianglesC;
      this.aByteArray3880 = var1.trianglePriorities;
      this.aByteArray3903 = var1.triangleTransparencies;
      ...
      if(var1.triangleTextureIds != null) {
         ...
         for(var9 = 0; var9 < this.anInt3889; ++var9) {
            short var10 = var1.triangleTextureIds[var9];
            if(var10 != -1 && Rasterizer.anInterface2_838.method17(var10)) {
      ...
      if(var1.anInt2862 > 0 && var1.aByteArray2866 != null) {
         ...
         for(var11 = 0; var11 < var1.anInt2862; ++var11) {
            if(var16[var11] > 0 && var1.aByteArray2857[var11] == 0) {
               this.anIntArray3882[var17] = var1.texTrianglesA[var11] & '\uffff';
               this.anIntArray3890[var17] = var1.texTrianglesB[var11] & '\uffff';
               this.anIntArray3881[var17] = var1.texTrianglesC[var11] & '\uffff';
               var16[var11] = var17++;
            } else {
               var16[var11] = -1;
            }
      ...
      for(var9 = 0; var9 < this.anInt3889; ++var9) {
         ...
         if(var1.triangleFaceTypes == null) {
            ...
            var18 = var1.triangleFaceTypes[var9];
         }
         ...
         if(var1.triangleTransparencies == null) {
            ...
            var19 = var1.triangleTransparencies[var9];
         }
         ...
         if(var12 == -1) {
            if(var18 == 0) {
               int color = var1.triangleColors[var9] & '\uffff';
               if(var1.aClass50Array2883 != null && var1.aClass50Array2883[this.anIntArray3901[var9]] != null) {
                  ...
                  var13 = var1.normalVertices[this.anIntArray3901[var9]];
               }

               var14 = var2 + (var4 * var13.x + var5 * var13.y + var6 * var13.z) / (var8 * var13.size) << 17;
               this.anIntArray3898[var9] = var14 | blendColor(color, var14 >> 17);
               if(var1.aClass50Array2883 != null && var1.aClass50Array2883[this.anIntArray3876[var9]] != null) {
                  ...
                  var13 = var1.normalVertices[this.anIntArray3876[var9]];
               }

               var14 = var2 + (var4 * var13.x + var5 * var13.y + var6 * var13.z) / (var8 * var13.size) << 17;
               this.anIntArray3874[var9] = var14 | blendColor(color, var14 >> 17);
               if(var1.aClass50Array2883 != null && var1.aClass50Array2883[this.anIntArray3887[var9]] != null) {
                  ...
                  var13 = var1.normalVertices[this.anIntArray3887[var9]];
               }

               var14 = var2 + (var4 * var13.x + var5 * var13.y + var6 * var13.z) / (var8 * var13.size) << 17;
               this.anIntArray3896[var9] = var14 | blendColor(color, var14 >> 17);
            } else if(var18 == 1) {
               var20 = var1.fixedNormalVertices[var9];
               var14 = var2 + (var4 * var20.x + var5 * var20.y + var6 * var20.z) / (var8 + var8 / 2) << 17;
               this.anIntArray3898[var9] = var14 | blendColor(var1.triangleColors[var9] & '\uffff', var14 >> 17);
            ...
            var14 = var2 + (var4 * var13.x + var5 * var13.y + var6 * var13.z) / (var8 * var13.size);
   ...
   private LDModel(LDModel[] var1, int var2) {
      boolean var3 = false;
      boolean var4 = false;
      boolean var5 = false;
      boolean var6 = false;
