...
final class LightManager {
   ...
   static final void method1269(int var0, boolean var1) {
      for(int var2 = 0; var2 < lightsPos; ++var2) {
   ...
   static final void method1270() {
      for(int var0 = 0; var0 < lightsPos; ++var0) {
   ...
   static final void method1277(int var0, int var1, GroundTile[][][] var2) {
      if(DisplayModeInformation.aBoolean1441) {
         GL var3 = HDToolkit.gl;
         Class3_Sub28_Sub4.method551(0, 0);
         HDToolkit.method1856(0);
         HDToolkit.method1823();
         HDToolkit.bindTexture(HDToolkit.anInt1810);
         ...
         label69:
         for(int var4 = 0; var4 < lightsPos; ++var4) {
            ...
            if(var5.aClass37_712 != null) {
               ...
               if(var9 >= PlainTile.anInt1665) {
                  var9 = PlainTile.anInt1665 - 1;
               }

               if(var8 < AbstractObjectCache.anInt3603) {
                  var7 += AbstractObjectCache.anInt3603 - var8;
                  var8 = AbstractObjectCache.anInt3603;
               }
         ...
         var3.glFogfv(2918, AtmosphereManager.aFloatArray1319, 0);
