...
final class Texture extends NodeSub {
   ...
   static jString aClass94_3792 = jString.createJString("huffman");
   ...
   final int[] method718(TextureInterface var1, int var2, float var3, js5 var4, boolean var5) {
      try {
         if(var2 != 0) {
            return (int[])null;
         } else {
               ...
               if(this.aBoolean3789) {
                  ...
                  for(var20 = 2; var20 >= 0; --var20) {
                     for(var11 = var17; var11 >= 0; --var11) {
                        ...
                        var7[var11] += ClientScript.method633(var12, 16726965) >> 16;
                        var8[var11] += ClientScript.method633('\uff72', var12) >> 8;
                        var9[var11] += ClientScript.method633(var12, 255);
                     }
                  ...
                  for(int var31 = var18; ~var31 <= -1; --var31) {
                     ...
                     for(var11 = var17; ~var11 <= -1; --var11) {
                        ...
                        var7[var11] += (ClientScript.method633(var24, 16729186) >> 16) + -ClientScript.method633(var23 >> 16, 255);
                        var8[var11] += (ClientScript.method633('\uff8b', var24) >> 8) + -ClientScript.method633(255, var23 >> 8);
                        var9[var11] += -ClientScript.method633(var23, 255) + ClientScript.method633(255, var24);
                     }
   ...
   final boolean method719(js5 var1, TextureInterface var2, int var3, boolean var4) {
      try {
         if(var3 != 579100487) {
            return false;
            ...
            if(~(1 & var7) == -1) {
               if(0 != ~this.anInt3795) {
                  HDToolkit.bindTexture(this.anInt3795);
               } else {
                  int[] var8 = new int[1];
                  ...
                  var5.glTexParameteri(3553, 10242, this.aBoolean3787 ? 10497 : '\u812f');
   ...
   final int[] method720(boolean var1, boolean var2, TextureInterface var3, js5 var4) {
      try {
         if(var1) {
   ...
   final boolean method722(int var1, TextureInterface var2, js5 var3) {
      try {
   ...
   static final void method724(int var0) {
      try {
         Class163_Sub2_Sub1.aClass93_4015.clearSoftReference();
         if(var0 > -106) {
            method725(71);
         }
   ...
   static final void method725(int var0) {
      try {
         ...
         if(~Class137.method1817() == -3) {
            byte var2 = (byte)(255 & VarBit.anInt1127 + -4);
            int var3 = VarBit.anInt1127 % 104;

            int var4;
            int var5;
            for(var4 = 0; -5 < ~var4; ++var4) {
               for(var5 = 0; 104 > var5; ++var5) {
                  AbstractGraphicsBuffer.aByteArrayArrayArray2008[var4][var3][var5] = var2;
               }
            }

            if(Class26.plane != 3) {
               for(var4 = 0; -3 < ~var4; ++var4) {
                  FileSystem.anIntArray686[var4] = -1000000;
                  MillisTimer.anIntArray2696[var4] = 1000000;
               ...
               if(1 == GrandExchangeItem.anInt1753) {
                  if((4 & Class9.aByteArrayArrayArray113[Class26.plane][TextureLoader.selfPlayer.anInt2819 >> 7][TextureLoader.selfPlayer.anInt2829 >> 7]) != 0) {
                     ItemPile.method2031((byte)-85, false, TextureLoader.selfPlayer.anInt2819 >> 7, TextureLoader.selfPlayer.anInt2829 >> 7, Class75_Sub2.groundTiles, 0);
                  }

                  if(-311 < ~Class139.renderPitch) {
                     int var7 = TextureLoader.selfPlayer.anInt2829 >> 7;
                     var5 = Class77.renderY >> 7;
                     int var9;
                     if(var5 < var7) {
                        var9 = var7 - var5;
                     } else {
                     ...
                     var4 = Npc.renderX >> 7;
                     int var6 = TextureLoader.selfPlayer.anInt2819 >> 7;
                     int var8;
                     if(~var6 < ~var4) {
                        var8 = -var4 + var6;
                     } else {
                     ...
                     if(var8 > var9) {
                        ...
                        while(var6 != var4) {
                           ...
                           if(~(Class9.aByteArrayArrayArray113[Class26.plane][var4][var5] & 4) != -1) {
                              ItemPile.method2031((byte)-29, false, var4, var5, Class75_Sub2.groundTiles, 1);
                              break;
                           }
                           ...
                           if(var11 >= 65536) {
                              ...
                              var11 -= 65536;
                              if(~(4 & Class9.aByteArrayArrayArray113[Class26.plane][var4][var5]) != -1) {
                                 ItemPile.method2031((byte)-120, false, var4, var5, Class75_Sub2.groundTiles, 1);
                                 break;
                              }
                           }
                        }
                        ...
                        while(~var5 != ~var7) {
                           ...
                           if(~(4 & Class9.aByteArrayArrayArray113[Class26.plane][var4][var5]) != -1) {
                              ItemPile.method2031((byte)-13, false, var4, var5, Class75_Sub2.groundTiles, 1);
                              break;
                           }
                           ...
                           if(~var11 <= -65537) {
                              ...
                              var11 -= 65536;
                              if((4 & Class9.aByteArrayArrayArray113[Class26.plane][var4][var5]) != 0) {
                                 ItemPile.method2031((byte)-37, false, var4, var5, Class75_Sub2.groundTiles, 1);
                                 break;
                              }
                           }
                        }
                  ...
                  var4 = Class121.method1736(Class26.plane, 1, Npc.renderX, Class77.renderY);
                  if(800 > var4 + -Class7.renderZ && (4 & Class9.aByteArrayArrayArray113[Class26.plane][Npc.renderX >> 7][Class77.renderY >> 7]) != 0) {
                     ItemPile.method2031((byte)-107, false, Npc.renderX >> 7, Class77.renderY >> 7, Class75_Sub2.groundTiles, 1);
                  }
               }
   ...
   Texture(Buffer var1) {
      try {
         ...
         this.aBoolean3789 = var1.getUByte() == 1;
         this.aBoolean3800 = 1 == var1.getUByte();
         this.aBoolean3787 = -2 == ~var1.getUByte();
         this.aBoolean3781 = ~var1.getUByte() == -2;
         int var2 = 3 & var1.getUByte();
