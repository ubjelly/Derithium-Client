...
final class Varp {
   ...
   int setting = 0;
   static js5 aClass153_557;
   static int[][][] anIantArrayArrayArray558;
   ...
   static final void method968(int var0) {
      try {
         ...
         for(var3 = 0; Class3_Sub13_Sub23.anInt3287 > var3; ++var3) {
            ItemDefinition var4 = ItemDefinition.method1023(var3);
   ...
   static final void method969(js5 var0, int var1) {
      try {
   ...
   private final void decode(Buffer buffer, int configCode) {
	   if(configCode == 5) {
           setting = buffer.getUShort();
        }
   }

	static final Varp list(int id) {
		Varp var2 = (Varp) Class136.aClass93_1772.get((long) id);
		if (var2 != null) {
			return var2;
		} else {
			byte[] var3 = Class3_Sub13_Sub13.varpJs5.getFile(16, id);
			var2 = new Varp();
			if (null != var3) {
				var2.decode(new Buffer(var3));
			}

			Class136.aClass93_1772.put(var2, (long) id);
			return var2;
		}
	}
